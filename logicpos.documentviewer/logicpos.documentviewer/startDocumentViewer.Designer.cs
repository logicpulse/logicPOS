...
{
    partial class startDocumentViewer
    {
        ...
        /// </summary>
        private void InitializeComponent(string docPath, int widthPDF, int heightPDF, bool export)
        {
            //this.TopLevel = true;
            this.TopMost = true;
            Patagames.Pdf.Net.Controls.WinForms.HighlightInfo.export = export;
