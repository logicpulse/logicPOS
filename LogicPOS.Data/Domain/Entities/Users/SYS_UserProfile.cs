...
namespace LogicPOS.Domain.Entities
{
    ...
    public class sys_userprofile : Entity
    {
        ...
        {
            Ord = XPOUtility.GetNextTableFieldID(nameof(sys_userprofile), "Ord");
            Code = XPOUtility.GetNextTableFieldID(nameof(sys_userprofile), "Code");
        }
