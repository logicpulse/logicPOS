...
namespace LogicPOS.Domain.Entities
{
    ...
    public class sys_configurationweighingmachine : Entity
    {
        ...
        {
            Ord = XPOUtility.GetNextTableFieldID(nameof(sys_configurationweighingmachine), "Ord");
            Code = XPOUtility.GetNextTableFieldID(nameof(sys_configurationweighingmachine), "Code");
        }
