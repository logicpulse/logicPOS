...
namespace LogicPOS.Domain.Entities
{
    ...
    public abstract class Entity : XPCustomObject
    {
        //Log4Net
        ...
        public Entity() : base() { }
        public Entity(Session pSession) : base(pSession) { }
        ...
        public pos_configurationplaceterminal CreatedWhere
        {
            ...
            set { SetPropertyValue("CreatedWhere", ref fCreatedWhere, value); }
        }
        ...
        public sys_userdetail UpdatedBy
        {
            ...
            set { SetPropertyValue("UpdatedBy", ref fUpdatedBy, value); }
        }
        ...
        public pos_configurationplaceterminal UpdatedWhere
        {
            ...
            set { SetPropertyValue("UpdatedWhere", ref fUpdatedWhere, value); }
        }
        ...
        public sys_userdetail DeletedBy
        {
            ...
            set { SetPropertyValue("DeletedBy", ref fDeletedBy, value); }
        }
        ...
        public pos_configurationplaceterminal DeletedWhere
        {
            ...
            set { SetPropertyValue("DeletedWhere", ref fDeletedWhere, value); }
        }
        ...
        protected override void OnSaving()
        {
            ...
            {
                UpdatedWhere = Session.GetObjectByKey<pos_configurationplaceterminal>(TerminalSettings.LoggedTerminal.Oid);
            }
            ...
            if (_isNewRecord)
            {
                ...
                if (TerminalSettings.LoggedTerminal != null)
                {
                    CreatedWhere = Session.GetObjectByKey<pos_configurationplaceterminal>(TerminalSettings.LoggedTerminal.Oid);
                }
        ...
        public override void AfterConstruction()
        {
            ...
            _isNewRecord = Oid == Guid.Empty;//true
        ...
        //protected override void AfterLoad()
        {
            ...
            {
                // Call SharedEncryptedDecryptProperties
                if (debug) _logger.Debug($"OnLoaded: [{GetType().Name}]");
                // DecryptProperties
                DecryptProperties();
            }
        }
