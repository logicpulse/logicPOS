...
namespace logicpos.financial.library.Classes.Hardware.Printers.Thermal.Tickets
{
    public class ThermalPrinterFinanceDocumentMaster : ThermalPrinterBaseFinanceTemplate
    {
        ...
        public void PrintDocumentMasterDocumentType()
        {
            ...
            /* IN008024 */
            //string appOperationModeToken = DataLayerFramework.Settings["appOperationModeToken"].ToLower();
        ...
        public void PrintDocumentDetails()
        {
            try
            {
                ...
                //columns.Add(new TicketColumn("Article", resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_article_acronym, 0, TicketColumnsAlign.Right, typeof(string), "{0:0.00}"));
