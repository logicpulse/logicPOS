        ...
        public void PrintDocumenWayBillDetails()
        {
            try
            {
                ...
                if (_documentFinanceMasterList[0].DocumentTypeWayBill)
                {
                    ...
                    _thermalPrinterGeneric.WriteLine(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_ship_from_delivery_date_report"), SharedUtils.DateTimeToString(_documentFinanceMasterList[0].ShipFromDeliveryDate));
                    ...
                    _thermalPrinterGeneric.WriteLine(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_ship_to_delivery_date_report"), SharedUtils.DateTimeToString(_documentFinanceMasterList[0].ShipToDeliveryDate));
