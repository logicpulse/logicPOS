...
namespace logicpos.financial.library.Classes.Stocks
{
    public class ProcessArticleStockParameter
    {
        ...
        {
            //if (pCustomer.Oid == Guid.Parse("00000000-0000-0000-0000-000000000002") && string.IsNullOrEmpty(_documentNumber)) pDocumentNumber = CultureResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_internal_document_footer1");
            Customer = pCustomer;
