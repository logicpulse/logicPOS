...
namespace LogicPOS.Reporting.Common
{
    ...
    {
        public static ReportDataList<FinanceMasterViewReportData> GetFinanceMasterViewReportDataList(Guid financeMasterId)
        {
            ReportDataList<FinanceMasterViewReportData> result = new ReportDataList<FinanceMasterViewReportData>();
            ...
            ReportDataList<FinanceMasterViewReportData> gcDocumentFinanceMaster = new ReportDataList<FinanceMasterViewReportData>(sqlFilter, 1);
            ReportDataList<FinanceDetailReportData> gcDocumentFinanceDetail;
            ReportDataList<FinanceMasterTotalViewReportData> gcDocumentFinanceMasterTotal;
            ...
            {
                //Get FinanceDetail 
                gcDocumentFinanceDetail = new ReportDataList<FinanceDetailReportData>(string.Format("DocumentMaster = '{0}'", documentMaster.Oid), "Ord");
                documentMaster.DocumentFinanceDetail = gcDocumentFinanceDetail.List;

                //Get FinanceMasterTotals
                gcDocumentFinanceMasterTotal = new ReportDataList<FinanceMasterTotalViewReportData>(string.Format("fmtDocumentMaster = '{0}'", documentMaster.Oid), "Value");
        ...
        public static ReportDataList<FinancePaymentViewReportData> GetFinancePaymentViewReportDataList(Guid financePaymentId)
        {
            ReportDataList<FinancePaymentViewReportData> result = new ReportDataList<FinancePaymentViewReportData>();
            ...
            ReportDataList<FinancePaymentViewReportData> gcDocumentFinancePayment = new ReportDataList<FinancePaymentViewReportData>(sqlFilter);
            ReportDataList<FinancePaymentDocumentViewReportData> gcDocumentFinancePaymentDocument;
            ...
            {
                //Get FinanceDetail 
                gcDocumentFinancePaymentDocument = new ReportDataList<FinancePaymentDocumentViewReportData>(string.Format("fpaOid = '{0}'", documentFinanceMasterPayment.Oid), "ftpCode, fmaDocumentNumber");
