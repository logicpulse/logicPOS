...
namespace LogicPOS.UI.Settings
{
    public partial class AppSettings
    {
        public static class Plugins
        {
            ...
            public static string AppCompanyName { get; set; } = "LogicPulse Technologies";
            ...
            {
                PluginContainer = new PluginContainer(Paths.Plugins);
                LicenceManager = PluginContainer.GetFirstPluginOfType<ILicenseManager>();
            }
        }
    }
}
