...
{
    internal class DialogCustomerDiscountGroup : EditDialog
    {
        public DialogCustomerDiscountGroup(Window parentWindow, XpoGridView pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
