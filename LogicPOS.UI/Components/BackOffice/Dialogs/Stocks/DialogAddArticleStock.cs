    ...
    internal class DialogAddArticleStock : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                _entryBoxSelectSupplier = new XPOEntryBoxSelectRecordValidation<erp_customer, TreeViewCustomer>(this, GeneralUtils.GetResourceByName("global_supplier"), "Name", "Oid", _initialSupplier, criteriaOperatorSupplier, LogicPOS.Utility.RegexUtils.RegexGuid, true, true);
                ...
                //DocumentDate
                _entryBoxDocumentDate = new EntryBoxValidationDatePickerDialog(this, GeneralUtils.GetResourceByName("global_date"), GeneralUtils.GetResourceByName("global_date"), _initialDocumentDate, LogicPOS.Utility.RegexUtils.RegexDate, true, CultureSettings.DateFormat, true);
                ...
                _entryBoxSelectArticle1 = new XPOEntryBoxSelectRecordValidation<fin_article, TreeViewArticle>(this, GeneralUtils.GetResourceByName("global_article"), "Designation", "Oid", null, criteriaOperatorSelectArticle, KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true, true, LogicPOS.Utility.RegexUtils.RegexAlfaNumericArticleCode, LogicPOS.Utility.RegexUtils.RegexDecimalPositiveAndNegative, _totalCompositeEntrys);

                //SerialNumber
                HBox hBoxSerialNumber = new HBox(false, 0);
                _entryBoxSerialNumber1 = new EntryBoxValidation(this, GeneralUtils.GetResourceByName("global_serial_number"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false, true);
                ...
                //Notes
                _entryBoxNotes = new EntryBoxValidation(this, GeneralUtils.GetResourceByName("global_notes"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false, true);
        ...
        private void NewBox_AddNewEntryEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                XPOEntryBoxSelectRecordValidation<fin_article, TreeViewArticle> NewEntryBoxSelectArticle = new XPOEntryBoxSelectRecordValidation<fin_article, TreeViewArticle>(this, GeneralUtils.GetResourceByName("global_article"), "Designation", "Oid", null, criteriaOperatorSelectArticle, KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true, true, LogicPOS.Utility.RegexUtils.RegexAlfaNumericArticleCode, LogicPOS.Utility.RegexUtils.RegexDecimalPositiveAndNegative, _totalCompositeEntrys);

                HBox hBoxArticles = new HBox(false, 0);

                //SerialNumber
                EntryBoxValidation NewEntryBoxSerialNumber = new EntryBoxValidation(this, GeneralUtils.GetResourceByName("global_serial_number"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false, true);
                ...
                //Price
                EntryBoxValidation NewEntryBoxPrice = new EntryBoxValidation(this, GeneralUtils.GetResourceByName("global_price"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexDecimalGreaterEqualThanZeroFinancial, false, true);
