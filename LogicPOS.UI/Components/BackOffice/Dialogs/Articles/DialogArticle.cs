    ...
    internal class DialogArticle : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            ...
            try
            {
                ...
                _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), _totalCompositeEntrys, GeneralUtils.GetResourceByName("global_designation"))) as GenericCRUDWidgetXPO);
                if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;

                _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), _totalCompositeEntrys, GeneralUtils.GetResourceByName("global_quantity"))) as GenericCRUDWidgetXPO);
                if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;
            ...
            try
            {
                foreach (fin_articlecomposition articleLine in _article.ArticleComposition)
                {
                    ...
                    if (_entryBoxSelectArticle1.Value == null)
                    {
                        ...
                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), 1, GeneralUtils.GetResourceByName("global_article_code"))) as GenericCRUDWidgetXPO);
                        _genericCRUDWidgetXPO.Validated = true;

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), 1, GeneralUtils.GetResourceByName("global_designation"))) as GenericCRUDWidgetXPO);
                        _genericCRUDWidgetXPO.Validated = true;

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), 1, GeneralUtils.GetResourceByName("global_quantity"))) as GenericCRUDWidgetXPO);
            ...
            try
            {
                ...
                if (!articleOid.Equals(Guid.Empty))
                {
                    ...
                    if (isArticleCode)
                    {
                        ...
                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), pXPOEntry.EntryNumber, GeneralUtils.GetResourceByName("global_article_code"))) as GenericCRUDWidgetXPO);
                        _genericCRUDWidgetXPO.Validated = true;

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), pXPOEntry.EntryNumber, GeneralUtils.GetResourceByName("global_designation"))) as GenericCRUDWidgetXPO);
                        _genericCRUDWidgetXPO.Validated = true;
            ...
            try
            {
                ...
                if (entrySelected != null)
                {
                    ...
                    else
                    {
                        ...
                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), entrySelected.EntryNumber, GeneralUtils.GetResourceByName("global_article_code"))) as GenericCRUDWidgetXPO);
                        _crudWidgetList.Remove(_genericCRUDWidgetXPO);

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), entrySelected.EntryNumber, GeneralUtils.GetResourceByName("global_designation"))) as GenericCRUDWidgetXPO);
                        _crudWidgetList.Remove(_genericCRUDWidgetXPO);

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), entrySelected.EntryNumber, GeneralUtils.GetResourceByName("global_quantity"))) as GenericCRUDWidgetXPO);
                        _crudWidgetList.Remove(_genericCRUDWidgetXPO);
        ...
        private void CheckButtonComposite_Toggled(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), i, GeneralUtils.GetResourceByName("global_article_code"))) as GenericCRUDWidgetXPO);
                    if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;

                    _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), i, GeneralUtils.GetResourceByName("global_designation"))) as GenericCRUDWidgetXPO);
                    if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;

                    _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", GeneralUtils.GetResourceByName("global_composite_article"), i, GeneralUtils.GetResourceByName("global_quantity"))) as GenericCRUDWidgetXPO);
                    if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;
                }
            }
        }
