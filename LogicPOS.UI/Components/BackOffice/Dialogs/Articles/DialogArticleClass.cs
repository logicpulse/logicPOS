...
{
    internal class DialogArticleClass : EditDialog
    {
        public DialogArticleClass(Window parentWindow, XpoGridView pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
        ...
        private void InitUI()
        {
            try
            {
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(boxAcronym, Entity, "Acronym", LogicPOS.Utility.RegexUtils.RegexAlfaAcronym1Char, true));
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(checkButtonWorkInStock, Entity, "WorkInStock"));
