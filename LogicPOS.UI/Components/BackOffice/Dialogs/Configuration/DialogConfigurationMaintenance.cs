...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    ...
    {
        public DialogConfigurationMaintenance(Window pSourceWindow, GenericTreeViewXPO pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
