...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    ...
    {
        public DialogConfigurationCashRegister(Window pSourceWindow, GenericTreeViewXPO pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
