...
{
    internal class DialogConfigurationPrintersTemplates : EditDialog
    {
        public DialogConfigurationPrintersTemplates(Window parentWindow, XpoGridView pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
        ...
        private void InitUI()
        {
            try
            {
                ...
                fileChooserFileTemplate.SetFilename(((sys_configurationprinterstemplates)Entity).FileTemplate);
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(boxfileChooserFileTemplate, Entity, "FileTemplate", string.Empty, false));
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(checkButtonFinancialTemplate, Entity, "FinancialTemplate"));
