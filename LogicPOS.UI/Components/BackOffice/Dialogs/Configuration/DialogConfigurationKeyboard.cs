...
{
    internal class DialogConfigurationKeyboard : EditDialog
    {
        public DialogConfigurationKeyboard(Window parentWindow, XpoGridView pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
        ...
        private void InitUI()
        {
            try
            {
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(boxLanguage, Entity, "Language", LogicPOS.Utility.RegexUtils.RegexAlfaNumeric, false));
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(boxVirtualKeyboard, Entity, "VirtualKeyboard", LogicPOS.Utility.RegexUtils.RegexAlfaNumeric, false));
