...
{
    internal class DialogConfigurationUnitMeasure : EditDialog
    {
        public DialogConfigurationUnitMeasure(Window parentWindow, XpoGridView pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
