...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    ...
    {
        public DialogConfigurationVatExemptionReason(Window pSourceWindow, GenericTreeViewXPO pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
