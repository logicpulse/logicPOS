...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    ...
    {
        public DialogConfigurationInputReader(Window pSourceWindow, GenericTreeViewXPO pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
