...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    ...
    {
        public DialogConfigurationPoleDisplay(Window pSourceWindow, GenericTreeViewXPO pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
