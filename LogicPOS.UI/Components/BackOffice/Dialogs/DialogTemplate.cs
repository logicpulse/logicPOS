...
{
    internal class DialogTemplate : EditDialog
    {
        public DialogTemplate(Window parentWindow, XpoGridView pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxNotes = new BOWidgetBox(CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_notes"), entryNotes);
                ...
                BOWidgetBox boxCreatedAt = new BOWidgetBox(CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_date"), entryCreatedAt);
                ...
                BOWidgetBox boxUpdatedAt = new BOWidgetBox(CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_date"), entryUpdatedAt);
                ...
                BOWidgetBox boxCreatedBy = new BOWidgetBox(CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_user, xpoComboBoxCreatedBy);
                ...
                BOWidgetBox boxCreatedWhere = new BOWidgetBox(CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_terminal, xpoComboBoxCreatedWhere);
                ...
                BOWidgetBox boxfileChooserButtonImage = new BOWidgetBox(CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_button_image, fileChooserButtonImage);
                ...
                Label labelMultilineNotes = new Label(CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_notes);
                ...
                //Append Tab
                _notebook.AppendPage(vboxTab2, new Label(CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_notes));
                */
