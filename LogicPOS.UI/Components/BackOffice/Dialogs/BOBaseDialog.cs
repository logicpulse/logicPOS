...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal abstract class BOBaseDialog : Dialog
    {
        ...
        protected void InitNotes()
        {
            ...
            Label labelMultiline = new Label(CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_notes"));
            ...
            //Append Tab
            _notebook.AppendPage(vbox, new Label(CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_notes")));
        }
        ...
        private void InitStatusBar()
        {
            if (_crudWidgetList != null)
            {
                ...
                Label labelUpdatedBy = new Label(CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_record_user_update"));
                ...
                Label labelCreatedAt = new Label(CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_record_date_created"));
                ...
                Label labelUpdatedAt = new Label(CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_record_date_updated_for_base_dialog"));
