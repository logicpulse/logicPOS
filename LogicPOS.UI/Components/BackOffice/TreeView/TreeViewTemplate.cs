...
{
    internal class TreeViewTemplate : XpoGridView
    {
        //Public Parametless Constructor Required by Generics
        public TreeViewTemplate() { }

        [Obsolete]
        public TreeViewTemplate(Window parentWindow)
            : this(parentWindow, null, null, null) { }

        //XpoMode
        [Obsolete]
        public TreeViewTemplate(Window parentWindow, Entity pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GridViewMode pGenericTreeViewMode = GridViewMode.Default, GridViewNavigatorMode navigatorMode = GridViewNavigatorMode.Default)
        {
            //Init Vars
