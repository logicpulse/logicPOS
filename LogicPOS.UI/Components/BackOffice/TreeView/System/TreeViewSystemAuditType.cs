...
{
    internal class TreeViewSystemAuditType : XpoGridView
    {
        //Public Parametless Constructor Required by Generics
        public TreeViewSystemAuditType() { }

        [Obsolete]
        public TreeViewSystemAuditType(Window parentWindow)
            : this(parentWindow, null, null, null) { }

        //XpoMode
        [Obsolete]
        public TreeViewSystemAuditType(Window parentWindow, Entity pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GridViewMode pGenericTreeViewMode = GridViewMode.Default, GridViewNavigatorMode navigatorMode = GridViewNavigatorMode.Default)
        {
            //Init Vars
