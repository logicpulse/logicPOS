...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    ...
    {
        //Settings
        private readonly string _fontGenericTreeViewColumnTitle = GeneralSettings.Settings["fontGenericTreeViewColumnTitle"];
        private readonly string _fontGenericTreeViewColumn = GeneralSettings.Settings["fontGenericTreeViewColumn"];
        ...
        public TreeViewUserProfilePermissions(Window pSourceWindow)
        {
            ...
            {
                new GenericTreeViewColumnProperty("Code") { Title = CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_record_code") },
                new GenericTreeViewColumnProperty("Designation") { Title = CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_user_profiles"), MaxWidth = 150 }
            };
        ...
        protected void InitObject(Window pSourceWindow, XPCollection pXPCollection, Type pXPGuidObjectType, Type pDialogType, List<GenericTreeViewColumnProperty> pColumnProperties, bool pShowStatusBar = false)
        {
            ...
            //Sorting
            _dataSource.Sorting = XPOUtility.GetXPCollectionDefaultSortingCollection();
        ...
        new protected void InitUI()
        {
            ...
            //{
            TouchButtonIconWithText buttonApplyPrivileges = Navigator.GetNewButton("touchButtonApplyPrivileges_DialogActionArea", CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_user_apply_privileges"), @"Icons/icon_pos_nav_refresh.png");
