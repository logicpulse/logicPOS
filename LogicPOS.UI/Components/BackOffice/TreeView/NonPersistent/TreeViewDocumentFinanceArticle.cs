...
{
    internal class TreeViewDocumentFinanceArticle : GridViewDataTable
    {
        //Public Parametless Constructor Required by Generics
        public TreeViewDocumentFinanceArticle() { }

        public TreeViewDocumentFinanceArticle(Window parentWindow)
            : this(parentWindow, null, null) { }

        //DataTable Mode
        public TreeViewDocumentFinanceArticle(Window parentWindow, DataRow pDefaultValue, Type pDialogType, GridViewMode pGenericTreeViewMode = GridViewMode.Default, GridViewNavigatorMode navigatorMode = GridViewNavigatorMode.Default)
        {
            //Init Vars
