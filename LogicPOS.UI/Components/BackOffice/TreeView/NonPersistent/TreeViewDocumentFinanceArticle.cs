    ...
    internal class TreeViewDocumentFinanceArticle : GenericTreeViewDataTable
    {
        ...
        public TreeViewDocumentFinanceArticle(Window pSourceWindow, DataRow pDefaultValue, Type pDialogType, GenericTreeViewMode pGenericTreeViewMode = GenericTreeViewMode.Default, GenericTreeViewNavigatorMode pGenericTreeViewNavigatorMode = GenericTreeViewNavigatorMode.Default)
        {
            ...
            List<GenericTreeViewColumnProperty> columnProperties = new List<GenericTreeViewColumnProperty>
            {
                ...
                /*02*/
                new GenericTreeViewColumnProperty("Article.Designation") { Type = typeof(fin_article), Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_designation"), ChildName = "Designation", MinWidth = 170, MaxWidth = 170 },
                /*03*/
                ...
                new GenericTreeViewColumnProperty("PriceDisplay") { Type = typeof(decimal), Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_price"), MinWidth = decimalsColumnWidth, MaxWidth = decimalsColumnWidth, Alignment = 1.0F, CellRenderer = cellRendererCurrency },
                /*06 IN009206*/
                new GenericTreeViewColumnProperty("Discount") { Type = typeof(decimal), Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_discount"), MinWidth = 60, MaxWidth = 60, Alignment = 1.0F, CellRenderer = cellRendererCurrency },
                /*07 IN009206*/
                new GenericTreeViewColumnProperty("VatExemptionReason.Acronym") { Type = typeof(fin_configurationvatexemptionreason), Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_vat_exemption_reason_acronym"), ChildName = "Acronym", MinWidth = 60, MaxWidth = 60, Visible = false },
                /*08*/
                new GenericTreeViewColumnProperty("ConfigurationVatRate.Value")
                {
                    Type = typeof(fin_configurationvatrate),
                    ChildName = "Value",
                    Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_vat_rate"),
                    MinWidth = 60,
                    MaxWidth = 60,
                    Alignment = 1.0F,
                ...
                /*09*/
                new GenericTreeViewColumnProperty("TotalNet") { Type = typeof(decimal), Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_total_article_tab"), MinWidth = decimalsColumnWidth, MaxWidth = decimalsColumnWidth, Alignment = 1.0F, CellRenderer = cellRendererCurrency },
                /*10*/ /* IN009206 */
                new GenericTreeViewColumnProperty("TotalFinal") { Type = typeof(decimal), Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_total_per_item_vat"), MinWidth = decimalsColumnWidth, MaxWidth = decimalsColumnWidth, Alignment = 1.0F, CellRenderer = cellRendererCurrency },
                ...
                /*16*/
                new GenericTreeViewColumnProperty("Article.Family") { Type = typeof(fin_articlefamily), Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_family"), ChildName = "Designation", MinWidth = 60, MaxWidth = 60, Visible = false },
                /*17*/
                new GenericTreeViewColumnProperty("Article.Subfamily") { Type = typeof(fin_articlesubfamily), Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_subfamily"), ChildName = "Designation", MinWidth = 60, MaxWidth = 60, Visible = false },
                /*18*/
                new GenericTreeViewColumnProperty("SerialNumber") { Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_serialnumber"), Type = typeof(string), Visible = true },
                /*19*/
            ...
            if (pGetArticlesFromCurrentOrderMain)
            {
                ...
                if (POSSession.CurrentSession.OrderMains.ContainsKey(POSSession.CurrentSession.CurrentOrderMainId))
                {
                    ...
                    foreach (var item in articleBag)
                    {
                        ...
                        article = (fin_article)XPOUtility.GetEntityById<fin_article>(item.Key.ArticleId);
                        configurationVatRate = 
                            XPOUtility.GetEntityById<fin_configurationvatrate>(
                                XPOUtility.GetGuidFromQuery($@"SELECT Oid FROM fin_configurationvatrate WHERE (Disabled IS NULL OR Disabled  <> 1) AND Value = '{item.Key.Vat}';")
                        );
                        //WIP: configurationUnitMeasure = (ConfigurationUnitMeasure)XPOUtility.GetXPGuidObjectFromSession(typeof(ConfigurationUnitMeasure), 
