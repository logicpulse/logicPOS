...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class TreeViewCustomerDiscountGroup : GenericTreeViewXPO
    {
        ...
        //XpoMode
        [Obsolete]
        public TreeViewCustomerDiscountGroup(Window pSourceWindow, Entity pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GenericTreeViewMode pGenericTreeViewMode = GenericTreeViewMode.Default, GenericTreeViewNavigatorMode pGenericTreeViewNavigatorMode = GenericTreeViewNavigatorMode.Default)
        {
            //Init Vars
