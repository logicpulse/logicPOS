...
{
    internal class TreeViewConfigurationPaymentCondition : XpoGridView
    {
        //Public Parametless Constructor Required by Generics
        public TreeViewConfigurationPaymentCondition() { }

        [Obsolete]
        public TreeViewConfigurationPaymentCondition(Window parentWindow)
            : this(parentWindow, null, null, null) { }

        //XpoMode
        [Obsolete]
        public TreeViewConfigurationPaymentCondition(Window parentWindow, Entity pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GridViewMode pGenericTreeViewMode = GridViewMode.Default, GridViewNavigatorMode navigatorMode = GridViewNavigatorMode.Default)
        {
            //Init Vars
            ...
            List<GridViewColumnProperty> columnProperties = new List<GridViewColumnProperty>
            {
                ...
                new GridViewColumnProperty("Acronym") { Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_ConfigurationPaymentCondition_Acronym") },
