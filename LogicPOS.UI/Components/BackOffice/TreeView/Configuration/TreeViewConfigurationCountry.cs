...
{
    internal class TreeViewConfigurationCountry : GenericTreeViewXPO
    {
        ...
        //XpoMode
        public TreeViewConfigurationCountry(Window pSourceWindow, Entity pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GenericTreeViewMode pGenericTreeViewMode = GenericTreeViewMode.Default, GenericTreeViewNavigatorMode pGenericTreeViewNavigatorMode = GenericTreeViewNavigatorMode.Default)
        {
            //Init Vars
