    ...
    internal class TreeViewConfigurationDevice : XpoGridView
    {
        ...
        public TreeViewConfigurationDevice(Window parentWindow, Entity pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GridViewMode pGenericTreeViewMode = GridViewMode.Default, GridViewNavigatorMode navigatorMode = GridViewNavigatorMode.Default)
        {
            ...
            List<GridViewColumn> columnProperties = new List<GridViewColumn>
            {
                ...
                new GridViewColumn("Type") { Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_ConfigurationDevice_Type") },
                new GridViewColumn("PlaceTerminal") { Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_ConfigurationDevice_PlaceTerminal") },
