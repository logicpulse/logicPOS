...
{
    internal class TreeViewConfigurationWeighingMachine : XpoGridView
    {
        //Public Parametless Constructor Required by Generics
        public TreeViewConfigurationWeighingMachine() { }

        [Obsolete]
        public TreeViewConfigurationWeighingMachine(Window parentWindow)
            : this(parentWindow, null, null, null) { }

        //XpoMode
        [Obsolete]
        public TreeViewConfigurationWeighingMachine(Window parentWindow, Entity pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GridViewMode pGenericTreeViewMode = GridViewMode.Default, GridViewNavigatorMode navigatorMode = GridViewNavigatorMode.Default)
        {
            //Init Vars
