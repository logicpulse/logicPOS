    ...
    public class BackOfficeMainWindow : BackOfficeBaseWindow
    {
        ...
        private Dictionary<string, AccordionNode> GetAccordionNodes()
        {
            ...
            Dictionary<string, AccordionNode> _accordionChildAuxiliarTables = new Dictionary<string, AccordionNode>
                {
                    { "ConfigurationCountry", new AccordionNode(GeneralUtils.GetResourceByName("global_country")) {
                        Content = Utils.GetGenericTreeViewXPO<GridViewCountries>(this) } },
            ...
            _accordionChildAuxiliarTables.Add("Warehouse", new AccordionNode(GeneralUtils.GetResourceByName("global_warehouse")) { Content = Utils.GetGenericTreeViewXPO<TreeViewWarehouse>(this) });
            ...
            Dictionary<string, AccordionNode> _accordionDevices = new Dictionary<string, AccordionNode>
                {
                    ...
                    { "ConfigurationPoleDisplay", new AccordionNode(GeneralUtils.GetResourceByName("global_ConfigurationPoleDisplay")) { Content = Utils.GetGenericTreeViewXPO<TreeViewConfigurationPoleDisplay>(this) } },
                    { "ConfigurationWeighingMachine", new AccordionNode(GeneralUtils.GetResourceByName("global_ConfigurationWeighingMachine")) { Content = Utils.GetGenericTreeViewXPO<TreeViewConfigurationWeighingMachine>(this) } }
                };
        ...
        private Dictionary<string, AccordionNode> CreateArticleButtons()
        {
            ...
            articleButtons.Add("ArticleType", new AccordionNode(GeneralUtils.GetResourceByName("global_article_types")) { Content = Utils.GetGenericTreeViewXPO<TreeViewArticleType>(this) });
