    ...
    public class BackOfficeMainWindow : BackOfficeBaseWindow
    {
        ...
        private Dictionary<string, AccordionNode> GetAccordionDefinition()
        {
            ...
            try
            {
                ...
                {
                    { "DocumentsNew", new AccordionNode(GeneralUtils.GetResourceByName("dialog_button_label_new_finance_documents")) { Clicked = delegate { logicpos.Utils.StartNewDocumentFromBackOffice(this); } } },
                    { "DocumentsShow", new AccordionNode(GeneralUtils.GetResourceByName("dialog_button_label_select_record_finance_documents")) { Clicked = delegate { logicpos.Utils.StartDocumentsMenuFromBackOffice(this, 1); } } },
                    { "DocumentsPay", new AccordionNode(GeneralUtils.GetResourceByName("dialog_button_label_select_finance_documents_ft_unpaid")) { Clicked = delegate { logicpos.Utils.StartDocumentsMenuFromBackOffice(this, 2); } } },
                    { "DocumentsPayments", new AccordionNode(GeneralUtils.GetResourceByName("dialog_button_label_select_payments")) { Clicked = delegate { logicpos.Utils.StartDocumentsMenuFromBackOffice(this, 3); } } },
                    { "DocumentsCurrentAccount", new AccordionNode(GeneralUtils.GetResourceByName("dialog_button_label_select_finance_documents_cc")) { Clicked = delegate { logicpos.Utils.StartDocumentsMenuFromBackOffice(this, 4); } } }
                };
                ...
                {
                    { "DocumentsReports", new AccordionNode(GeneralUtils.GetResourceByName("global_reports")) { Clicked = delegate { logicpos.Utils.StartReportsMenuFromBackOffice(this); } } }
                };
                ...
                Dictionary<string, AccordionNode> _accordionChildArticles = new Dictionary<string, AccordionNode>
                {
                    ...
                    { "ArticleFamily", new AccordionNode(GeneralUtils.GetResourceByName("global_families")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewArticleFamily>(this) } }
                };
                ;
                _accordionChildArticles.Add("ArticleSubFamily", new AccordionNode(GeneralUtils.GetResourceByName("global_subfamilies")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewArticleSubFamily>(this) });
                _accordionChildArticles.Add("Article", new AccordionNode(GeneralUtils.GetResourceByName("global_articles")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewArticle>(this) });
                _accordionChildArticles.Add("ArticleType", new AccordionNode(GeneralUtils.GetResourceByName("global_article_types")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewArticleType>(this) });
                _accordionChildArticles.Add("ArticleClass", new AccordionNode(GeneralUtils.GetResourceByName("global_article_class")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewArticleClass>(this) });
                _accordionChildArticles.Add("ConfigurationPriceType", new AccordionNode(GeneralUtils.GetResourceByName("global_price_type")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationPriceType>(this) });
                // Disable to Speed uo Opening BO, noew we have Stock Reports
                _accordionChildArticles.Add("ArticleStock", new AccordionNode(GeneralUtils.GetResourceByName("global_stock_movements")) { /*Content = Utils.GetGenericTreeViewXPO<TreeViewArticleStock>(this),*/ Clicked = delegate { logicpos.Utils.OpenArticleStockDialog(this); } });

                //Customers
                Dictionary<string, AccordionNode> _accordionChildCustomers = new Dictionary<string, AccordionNode>
                {
                    { "Customer", new AccordionNode(GeneralUtils.GetResourceByName("global_customers")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewCustomer>(this, criteriaOperatorCustomer) } },
                    { "CustomerType", new AccordionNode(GeneralUtils.GetResourceByName("global_customer_types")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewCustomerType>(this) } },
                    { "CustomerDiscountGroup", new AccordionNode(GeneralUtils.GetResourceByName("global_customer_discount_groups")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewCustomerDiscountGroup>(this) } }
                };

                //Users
                Dictionary<string, AccordionNode> _accordionChildUsers = new Dictionary<string, AccordionNode>
                {
                    { "UserDetail", new AccordionNode(GeneralUtils.GetResourceByName("global_users")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewUser>(this) } },
                    ...
                    { "UserPermissionProfile", new AccordionNode(GeneralUtils.GetResourceByName("global_user_permissions")) { Content = new TreeViewUserProfilePermissions(this) } },
                    { "UserCommissionGroup", new AccordionNode(GeneralUtils.GetResourceByName("global_user_commission_groups")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewUserCommissionGroup>(this) } }
                };
                ...
                {
                    { "DocumentFinanceYears", new AccordionNode(GeneralUtils.GetResourceByName("global_documentfinance_years")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewDocumentFinanceYears>(this) } },
                    { "DocumentFinanceSeries", new AccordionNode(GeneralUtils.GetResourceByName("global_documentfinance_series")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewDocumentFinanceSeries>(this) } },
                    { "DocumentFinanceType", new AccordionNode(GeneralUtils.GetResourceByName("global_documentfinance_type")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewDocumentFinanceType>(this) } },
                    ...
                    { "ConfigurationVatRate", new AccordionNode(GeneralUtils.GetResourceByName("global_vat_rates")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationVatRate>(this) } },
                    { "ConfigurationVatExemptionReason", new AccordionNode(GeneralUtils.GetResourceByName("global_vat_exemption_reason")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationVatExceptionReason>(this) } },
                    { "ConfigurationPaymentCondition", new AccordionNode(GeneralUtils.GetResourceByName("global_payment_conditions")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationPaymentCondition>(this) } },
                    { "ConfigurationPaymentMethod", new AccordionNode(GeneralUtils.GetResourceByName("global_payment_methods")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationPaymentMethod>(this) } }
                };
                ...
                Dictionary<string, AccordionNode> _accordionChildAuxiliarTables = new Dictionary<string, AccordionNode>
                {
                    ...
                    { "ConfigurationCountry", new AccordionNode(GeneralUtils.GetResourceByName("global_country")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationCountry>(this) } },
                    { "ConfigurationCurrency", new AccordionNode(GeneralUtils.GetResourceByName("global_ConfigurationCurrency")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationCurrency>(this) } },
                    ...
                    { "ConfigurationPlace", new AccordionNode(GeneralUtils.GetResourceByName("global_places")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationPlace>(this) } }
                };
                /* IN009035 */
                ...
                _accordionChildAuxiliarTables.Add("ConfigurationPlaceMovementType", new AccordionNode(GeneralUtils.GetResourceByName("global_places_movement_type")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationPlaceMovementType>(this) });
                _accordionChildAuxiliarTables.Add("ConfigurationUnitMeasure", new AccordionNode(GeneralUtils.GetResourceByName("global_units_measure")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationUnitMeasure>(this) });
                _accordionChildAuxiliarTables.Add("ConfigurationUnitSize", new AccordionNode(GeneralUtils.GetResourceByName("global_units_size")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationUnitSize>(this) });
                _accordionChildAuxiliarTables.Add("ConfigurationHolidays", new AccordionNode(GeneralUtils.GetResourceByName("global_holidays")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationHolidays>(this) });
                _accordionChildAuxiliarTables.Add("Warehouse", new AccordionNode(GeneralUtils.GetResourceByName("global_warehouse")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewWarehouse>(this) });


                //Devices
                Dictionary<string, AccordionNode> _accordionDevices = new Dictionary<string, AccordionNode>
                {
                    { "ConfigurationPrintersType", new AccordionNode(GeneralUtils.GetResourceByName("global_ConfigurationPrintersType")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationPrintersType>(this) } },
                ...
                {
                    { "ConfigurationPreferenceParameterCompany", new AccordionNode(GeneralUtils.GetResourceByName("global_preferenceparameter_company")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationPreferenceParameter>(this, criteriaConfigurationPreferenceParameterCompany) } },
                    { "ConfigurationPreferenceParameterSystem", new AccordionNode(GeneralUtils.GetResourceByName("global_preferenceparameter_system")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationPreferenceParameter>(this, criteriaConfigurationPreferenceParameterSystem) } },
                    { "ConfigurationPlaceTerminal", new AccordionNode(GeneralUtils.GetResourceByName("global_places_terminals")) { Content = logicpos.Utils.GetGenericTreeViewXPO<TreeViewConfigurationPlaceTerminal>(this) } }
                };
                ...
                Dictionary<string, AccordionNode> _accordionChildSystem = new Dictionary<string, AccordionNode>
                {
                    ...
                    { "System_Notification", new AccordionNode(GeneralUtils.GetResourceByName("window_title_dialog_notification")) { Clicked = delegate { logicpos.Utils.ShowNotifications(this, true); } } },
                    { "System_ChangeLog", new AccordionNode(GeneralUtils.GetResourceByName("change_logger")) { Clicked = delegate { logicpos.Utils.ShowChangeLog(this); } } }
                };
                // Add Menu Items Based On Plugins PluginSoftwareVendor
                ...
                _accordionChildSystem.Add("System_Menu", new AccordionNode(GeneralUtils.GetResourceByName("global_application_loggerout_user")) { Clicked = ClickedSystemLogout });
                ...
                if (GeneralSettings.AppUseBackOfficeMode)
                {
                    accordionDefinition.Add("TopMenuFinanceDocuments", new AccordionNode(GeneralUtils.GetResourceByName("dialog_button_label_select_record_finance_documents")) { Childs = _accordionChildDocuments, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_documentos.png") });
                }
                accordionDefinition.Add("TopMenuArticles", new AccordionNode(GeneralUtils.GetResourceByName("global_articles")) { Childs = _accordionChildArticles, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_artigos.png") });
                accordionDefinition.Add("TopMenuDocuments", new AccordionNode(GeneralUtils.GetResourceByName("global_documents")) { Childs = _accordionDocuments, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_informacao_fiscal.png") });
                accordionDefinition.Add("TopMenuCustomers", new AccordionNode(GeneralUtils.GetResourceByName("global_customers")) { Childs = _accordionChildCustomers, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_clientes.png") });
                accordionDefinition.Add("TopMenuUsers", new AccordionNode(GeneralUtils.GetResourceByName("global_users")) { Childs = _accordionChildUsers, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_utilizadores.png") });
                accordionDefinition.Add("TopMenuDevices", new AccordionNode(GeneralUtils.GetResourceByName("global_devices")) { Childs = _accordionDevices, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_impressoras.png") });
                accordionDefinition.Add("TopMenuOtherTables", new AccordionNode(GeneralUtils.GetResourceByName("global_other_tables")) { Childs = _accordionChildAuxiliarTables, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_outras_tabelas.png") });
                accordionDefinition.Add("TopMenuConfiguration", new AccordionNode(GeneralUtils.GetResourceByName("global_configuration")) { Childs = _accordionChildConfiguration, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_configuracao.png") });
                //TK016235 BackOffice - Mode
                if (GeneralSettings.AppUseBackOfficeMode)
                {
                    accordionDefinition.Add("TopMenuReports", new AccordionNode(GeneralUtils.GetResourceByName("global_reports")) { Childs = _accordionChildReports, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_relatorios.png") });
                }

                accordionDefinition.Add("TopMenuImport", new AccordionNode(GeneralUtils.GetResourceByName("global_import")) { Childs = _accordionChildImport, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_import.png") });

                if (_accordionChildExport.Count > 0)
                {
                    accordionDefinition.Add("TopMenuExport", new AccordionNode(GeneralUtils.GetResourceByName("global_export")) { Childs = _accordionChildExport, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_export.png") });
                }
                accordionDefinition.Add("TopMenuSystem", new AccordionNode(GeneralUtils.GetResourceByName("global_system")) { Childs = _accordionChildSystem, GroupIcon = new Image("Assets/Images/Icons/Accordion/pos_backoffice_sistema.png") });
