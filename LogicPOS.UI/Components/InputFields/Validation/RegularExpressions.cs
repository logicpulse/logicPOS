...
namespace LogicPOS.UI.Components.InputFields.Validation
{
    public class RegularExpressions
    {
        ...
        public static string Date => @"^(((([0-9][0-9][0-9][1-9])|([1-9][0-9][0-9][0-9])|([0-9][1-9][0-9][0-9])|([0-9][0-9][1-9][0-9]))[-\/\\.]((0[13578])|(1[02]))[-\/\\.]((0[1-9])|([12][0-9])|(3[01])))|((([0-9][0-9][0-9][1-9])|([1-9][0-9][0-9][0-9])|([0-9][1-9][0-9][0-9])|([0-9][0-9][1-9][0-9]))[-\/\\.]((0[469])|11)[-\/\\.]((0[1-9])|([12][0-9])|(30)))|(((000[48])|([0-9]0-9)|([0-9][1-9][02468][048])|([1-9][0-9][02468][048])|([0-9]0-9)|([0-9][1-9][13579][26])|([1-9][0-9][13579][26]))[-\/\\.]02[-\/\\.]((0[1-9])|([12][0-9])))|((([0-9][0-9][0-9][1-9])|([1-9][0-9][0-9][0-9])|([0-9][1-9][0-9][0-9])|([0-9][0-9][1-9][0-9]))[-\/\\.]02[-\/\\.]((0[1-9])|([1][0-9]\S*)|([2][0-8]\S*)\S*)\S*)\S*)$";
        public static string DateTime => @"^(((\d\d)(([02468][048])|([13579][26]))[-\/\\.]02[-\/\\.]29)|(((\d\d)(\d\d)))[-\/\\.]((((0\d)|(1[0-2]))[-\/\\.]((0\d)|(1\d)|(2[0-8])))|((((0[13578])|(1[02]))-31)|(((0[1,3-9])|(1[0-2]))-(29|30)))))\s(([01]\d|2[0-3]):([0-5]\d):([0-5]\d))$";
