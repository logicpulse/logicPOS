...
namespace LogicPOS.UI.Components.Modals
{
    ...
    {
        #region Components
        public PageTextBox TxtStartDate { get; set; }
        public PageTextBox TxtEndDate { get; set; }
        public PageTextBox TxtDocumentType { get; set; }
        public PageTextBox TxtCustomer { get; set; }
        public PageTextBox TxtWarehouse { get; set; }
        public PageTextBox TxtVatRate { get; set; }
