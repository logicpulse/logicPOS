    ...
    public partial class TablesModal
    {
        ...
        private void InitializeButtons()
        {
            BtnReservation = CreateButton("touchButtonTableReservation_DialogActionArea",
                                          LocalizedString.Instance["pos_button_label_table_reservation"],
            ...
            BtnFilterAll = CreateButton("touchButton_Green",
                                        LocalizedString.Instance["dialog_orders_button_label_tables_all"],
                                        AppSettings.Paths.Images + @"Icons\icon_pos_table_filter_all.png");

            BtnFilterFree = CreateButton("touchButton_Green", LocalizedString.Instance["dialog_orders_button_label_tables_free"],
                                         AppSettings.Paths.Images + @"Icons\icon_pos_table_filter_free.png");

            BtnFilterOpen = CreateButton("touchButton_Green", LocalizedString.Instance["dialog_orders_button_label_tables_open"],
                                         AppSettings.Paths.Images + @"Icons\icon_pos_table_filter_open.png");

            BtnFilterReserved = CreateButton("touchButton_Green", LocalizedString.Instance["dialog_orders_button_label_tables_reserved"],
                                             AppSettings.Paths.Images + @"Icons\icon_pos_table_filter_reserved.png");

            BtnViewOrders = CreateButton("touchButton_Red", LocalizedString.Instance["dialog_orders_button_label_view_orders"],
                                         AppSettings.Paths.Images + @"Icons\icon_pos_retail_view_order.png");

            BtnViewTables = CreateButton("touchButton_Green", LocalizedString.Instance["dialog_orders_button_label_view_tables"],
