...
namespace LogicPOS.UI.Components.Pages
{
    public partial class TablesPage : Page<TableViewModel>
    {
        ...
        {
            this.Navigator.BtnInsert.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Tables.BACKOFFICE_MAN_CONFIGURATIONPLACETABLE_CREATE);
            this.Navigator.BtnDelete.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Tables.BACKOFFICE_MAN_CONFIGURATIONPLACETABLE_DELETE);
            this.Navigator.BtnUpdate.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Tables.BACKOFFICE_MAN_CONFIGURATIONPLACETABLE_EDIT);
            this.Navigator.BtnView.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Tables.BACKOFFICE_MAN_CONFIGURATIONPLACETABLE_VIEW);
        }
