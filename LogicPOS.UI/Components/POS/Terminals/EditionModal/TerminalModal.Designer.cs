...
namespace LogicPOS.UI.Components.Modals
{
    public partial class TerminalModal
    {
        ...
        private void InitializeThermalPrintersComboBox()
        {
            ...
            var labelText = LocalizedString.Instance["global_printer_thermal_printer"];
        ...
        private void InitializePoleDisplaysComboBox()
        {
            ...
            var labelText = LocalizedString.Instance["global_ConfigurationPoleDisplay"];
        ...
        private void InitializeWeighingMachinesComboBox()
        {
            ...
            var labelText = LocalizedString.Instance["global_ConfigurationWeighingMachine"];
        ...
        private void InitializeBarcodeReadersComboBox()
        {
            ...
            var labelText = LocalizedString.Instance["global_input_barcode_reader"];
        ...
        private void InitializeCardReadersComboBox()
        {
            ...
            var labelText = LocalizedString.Instance["global_input_reader_card_reader"];
        ...
        protected override IEnumerable<(VBox Page, string Title)> CreateTabs()
        {
            ...
            yield return (CreateDevicesTab(), LocalizedString.Instance["global_devices"]);
