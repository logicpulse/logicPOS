...
{
    internal class PosPricePickerDialog : BaseDialog
    {
        //Moçambique 5/4/21
        //Private Members
        //UI
        ...
        public PosPricePickerDialog(Window parentWindow, DialogFlags pDialogFlags, fin_article pArticle)
            : base(parentWindow, pDialogFlags)
        {
            ...
            WindowSettings.Size = new Size(300, 473);
        ...
        public static string RequestPriceTypeValue(Window parentWindow, DialogFlags pDialogFlags, fin_article pArticle)
        {
            PosPricePickerDialog dialog;

            dialog = new PosPricePickerDialog(parentWindow, pDialogFlags, pArticle);
