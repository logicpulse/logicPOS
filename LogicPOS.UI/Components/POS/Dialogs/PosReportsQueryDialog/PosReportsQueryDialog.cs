...
namespace logicpos.Classes.Gui.Gtk.Pos.Dialogs
{
    internal partial class PosReportsQueryDialog : BaseDialog
    {
        ...
        private XPOEntryBoxSelectRecordValidation<cfg_configurationcountry, GridViewCountries> _entryBoxSelectShipFromCountry;
        ...
        public PosReportsQueryDialog(Window parentWindow, DialogFlags pDialogFlags, ReportsQueryDialogMode pReportsQueryDialogMode, string pDatabaseSourceObject, string windowTitle)
            : base(parentWindow, pDialogFlags)
        {
            ...
            WindowSettings.WindowTitle.Text = windowTitle;

            InitUI(pDialogFlags, dateTimeStart, dateTimeEnd);
        }

        public PosReportsQueryDialog(Window parentWindow, DialogFlags pDialogFlags, DateTime pDateStart, DateTime pDateEnd)
            : base(parentWindow, pDialogFlags)
        {
            //Call Init UI
        ...
        private void InitUI(DialogFlags pDialogFlags, DateTime pDateStart, DateTime pDateEnd)
        {
            ...
            //Init Local Vars
            string windowTitle = WindowSettings.WindowTitle.Text;
            ...
            _buttonCleanFilter = ActionAreaButton.FactoryGetDialogButtonType(DialogButtonType.CleanFilter, "Clean Filter", GeneralUtils.GetResourceByName("global_button_label_filter_clear"), fileActionFilter);
            //Export to Xls/pdf
            _buttonExportPdf = ActionAreaButton.FactoryGetDialogButtonType(DialogButtonType.ExportPdf, "touchButtonPosToolbarFinanceDocuments_Red", GeneralUtils.GetResourceByName("global_button_label_export_pdf"), fileActionExportPdf);
            _buttonExportXls = ActionAreaButton.FactoryGetDialogButtonType(DialogButtonType.ExportXls, "touchButtonPosToolbarFinanceDocuments_Green", GeneralUtils.GetResourceByName("global_button_label_export_xls"), fileActionExportXls);
...
Oid = '{DocumentSettings.ConsignationInvoiceId}'
            ...
            {
                _entryBoxSelectShipFromCountry = SelectionBoxFactory<cfg_configurationcountry, GridViewCountries>(GeneralUtils.GetResourceByName("global_country"));
