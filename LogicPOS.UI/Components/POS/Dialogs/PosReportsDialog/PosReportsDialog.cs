...
{
    internal partial class PosReportsDialog : BaseDialog
    {
        ...
        public PosReportsDialog(Window parentWindow, DialogFlags pDialogFlags)
            : base(parentWindow, pDialogFlags)
        {
            ...
            //Init Object
            this.Initialize(this, pDialogFlags, fileDefaultWindowIcon, windowTitle, windowSize, _scrolledWindow, null);
        }
        ...
        private Dictionary<string, AccordionNode> GetAccordionDefinition()
        {
            ...
            foreach (rpt_reporttype reportType in xpoCollection)
            {
                ...
                if (string.IsNullOrEmpty(buttonLabelReportTypeString))
                {
                    ...
                    buttonLabelReportTypeString = $"${reportType.ResourceString.Replace("_", "-")}$";
                }
