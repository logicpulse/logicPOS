    ...
    internal class DocumentFinanceDialogPage2 : PagePadPage
    {
            ...
            : base(pSourceWindow, pPageName, pPageIcon, pWidget, pEnabled)
        {
            ...
            EntryBoxSelectCustomerName = new XPOEntryBoxSelectRecordValidation<erp_customer, TreeViewCustomer>(
                _sourceWindow,
                CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_customer"),
                "Name",
                "Name",
                customer,
            ...
            //Customer Address
            EntryBoxCustomerAddress = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_address"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericPlus, false);/* IN009253 */
            EntryBoxCustomerAddress.EntryValidation.Changed += delegate { Validate(); };

            //Customer Locality
            EntryBoxCustomerLocality = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_locality"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericPlus, false);/* IN009253 */
            EntryBoxCustomerLocality.EntryValidation.Changed += delegate { Validate(); };

            //Customer ZipCode
            EntryBoxCustomerZipCode = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_zipcode"), KeyboardMode.Alfa, XPOSettings.ConfigurationSystemCountry.RegExZipCode, false);
            EntryBoxCustomerZipCode.EntryValidation.Changed += delegate { Validate(); };

            //Customer City
            EntryBoxCustomerCity = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_city"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericPlus, false);/* IN009253 */
            ...
            EntryBoxSelectCustomerFiscalNumber = new XPOEntryBoxSelectRecordValidation<erp_customer, TreeViewCustomer>(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_fiscal_number"), "FiscalNumber", "FiscalNumber", null, criteriaOperatorCustomerFiscalNumber, KeyboardMode.AlfaNumeric, EntryBoxSelectCustomerCountry.Value.RegExFiscalNumber, true);
            ...
            EntryBoxSelectCustomerCardNumber = new XPOEntryBoxSelectRecordValidation<erp_customer, TreeViewCustomer>(
                _sourceWindow,
                CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_card_number"),
                "CardNumber",
                "CardNumber",
                null,
            ...
            EntryBoxCustomerDiscount = new EntryBoxValidation(
                _sourceWindow,
                CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_discount"),
                KeyboardMode.Alfa,
            ...
            //Customer Phone
            EntryBoxCustomerPhone = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_phone"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false);
            EntryBoxCustomerPhone.EntryValidation.Changed += delegate { Validate(); };

            //Customer Email
            EntryBoxCustomerEmail = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_email"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexEmail, false);
            EntryBoxCustomerEmail.EntryValidation.Changed += delegate { Validate(); };

            //Customer Notes
            EntryBoxCustomerNotes = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_notes"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false);
        ...
        public void UpdateCustomerEditMode()
        {
            try
            {
                ...
                if (PluginSettings.HasSoftwareVendorPlugin)
                {
                    fiscalNumberFilterValue = PluginSettings.SoftwareVendor.Encrypt(EntryBoxSelectCustomerFiscalNumber.EntryValidation.Text);
                }
