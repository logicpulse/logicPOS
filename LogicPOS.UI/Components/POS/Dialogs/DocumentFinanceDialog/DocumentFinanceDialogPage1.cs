...
(
    ...
    Token = 'BANK_TRANSFER' {0}
            ...
            EntryBoxSelectCopyDocumentFinance = new XPOEntryBoxSelectRecordValidation<fin_documentfinancemaster, TreeViewDocumentFinanceMaster>(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_copy_finance_document"), "DocumentNumber", "Oid", null, criteriaOperatorCopyDocumentFinance, LogicPOS.Utility.RegexUtils.RegexGuid, false);
            ...
            //Customer Notes
            EntryBoxDocumentMasterNotes = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_notes"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false);

            //Reason
            EntryBoxReason = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "global_reason"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtendedForMotive, false);
                    ...
                    || CustomDocumentSettings.DeliveryNoteDocumentTypeId.Equals(oid))
                {
                    ...
                    if (addToTree.Count <= 0)
                    {
                        ...
                        string message = string.Format(
                            CultureResources.GetResourceByLanguage(CultureSettings.CurrentCultureName, "dialog_message_info_all_lines_from_this_document_was_already_credited"),
