...
{
    internal class PosEditCompanyDetails : BaseDialog
    {
        //Private UI
        private readonly IconButtonWithText _buttonOk;
        private readonly IconButtonWithText _buttonDataDemo;
        private ScrolledWindow _scrolledWindow;
        private EntryBoxValidation _entryBoxFiscalNumber;
        private EntryBoxValidation _entryBoxZipCode;
        private XPOEntryBoxSelectRecordValidation<cfg_configurationcountry, GridViewCountries> _entryBoxSelectSystemCountry;
        ...
        public PosEditCompanyDetails(Window parentWindow, DialogFlags pDialogFlags, bool useDataDemo)
            : base(parentWindow, pDialogFlags, true, false)
        {
            ...
            //ActionArea Buttons
            _buttonOk = new IconButtonWithText(
                new ButtonSettings
                {
                    ...
                    Icon = IconSettings.ActionOK,
                    IconSize = SizeSettings.ActionAreaButtonIcon,
                    ButtonSize = SizeSettings.ActionAreaButton
                }){ Sensitive = false };

            _buttonDataDemo = new IconButtonWithText(
                new ButtonSettings
                {
                    Name = "touchButtonDataDemo_DialogActionArea",
                    BackgroundColor = ColorSettings.ActionAreaButtonBackground,
                    Text = "Demo-Tchialo Hahaha",
                    Font = FontSettings.ActionAreaButton,
                    FontColor = ColorSettings.ActionAreaButtonFont,
                    Icon = IconSettings.DemoData,
                    IconSize = SizeSettings.ActionAreaButtonIcon,
                    ButtonSize = SizeSettings.ActionAreaButton
                }) { Sensitive = true };
        ...
        private void InitUI(bool useDataDemo)
        {
            ...
            if (AppSettings.Instance.xpoOidConfigurationCountrySystemCountry != string.Empty)
            {
                systemCountry = new Guid(AppSettings.Instance.xpoOidConfigurationCountrySystemCountry);
            }
            else
            {
            ...
            if (AppSettings.Instance.xpoOidConfigurationCurrencySystemCurrency != string.Empty)
            {
                systemCurrency = new Guid(AppSettings.Instance.xpoOidConfigurationCurrencySystemCurrency);
            }
            else
            {
            ...
            _entryBoxSelectSystemCountry = new XPOEntryBoxSelectRecordValidation<cfg_configurationcountry, GridViewCountries>(this, GeneralUtils.GetResourceByName("global_country"), "Designation", "Oid", intialValueConfigurationCountry, criteriaOperatorSystemCountry, RegexUtils.RegexGuid, true);
