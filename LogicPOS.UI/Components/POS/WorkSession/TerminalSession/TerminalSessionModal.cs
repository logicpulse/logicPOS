...
namespace LogicPOS.UI.Components.POS
{
    public partial class TerminalSessionModal : Modal
    {
        ...
        private PageTextBox TxtAmount { get; set; }
        private PageTextBox TxtDescription { get; set; }
        ...
        {
            TxtAmount = new PageTextBox(this,
            ...
            TxtDescription = new PageTextBox(sourceWindow: this,
