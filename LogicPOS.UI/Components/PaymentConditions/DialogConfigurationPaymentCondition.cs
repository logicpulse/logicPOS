...
{
    internal class DialogConfigurationPaymentCondition : EditDialog
    {
        public DialogConfigurationPaymentCondition(Window parentWindow, XpoGridView pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
        ...
        private void InitUI()
        {
            try
            {
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(boxAcronym, Entity, "Acronym", LogicPOS.Utility.RegexUtils.RegexAcronym2Or3Chars, true));
