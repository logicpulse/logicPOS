...
namespace LogicPOS.UI.Components.InputFields.Validation
{
    public class RegularExpressions
    {
        ...
        public static string Money => $@"^(?!(0|0{DecimalSeparator}0+)$)\d+({DecimalSeparator}\d{{1,2}})?$";
        ...
        public static string AlfaNumericArticleCode => @"^.{0,}$";// @"^[0-9A-Za-z€$&@#%()\[\]+\-_ \.\\\/]{2,25}$"; LUCIANO
        ...
        public static string AngolanFiscalNumber => @"^[0-9A-Z]{9,}$";
