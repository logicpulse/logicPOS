...
namespace LogicPOS.UI.Components.Modals
{
    public partial class CurrencyModal
    {
        ...
        private TextBox _txtAcronym = new TextBox("global_ConfigurationCurrency_Acronym", true);
        private TextBox _txtExchangeRate = new TextBox("global_exchangerate", true,true, @"^\d+([.,]\d+)?$");
        private TextBox _txtEntity = new TextBox("global_ConfigurationCurrency_Entity");
