...
{
    internal class DialogConfigurationCurrency : EditDialog
    {
        public DialogConfigurationCurrency(Window parentWindow, XpoGridView pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
        ...
        private void InitUI()
        {
            try
            {
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(boxDesignation, Entity, "Designation", LogicPOS.Utility.RegexUtils.RegexAlfa, true));
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(boxAcronym, Entity, "Acronym", LogicPOS.Utility.RegexUtils.RegexAlfaNumeric, true));
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(boxEntity, Entity, "Entity", LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false));
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(boxExchangeRate, Entity, "ExchangeRate", LogicPOS.Utility.RegexUtils.RegexDecimal, true));
