...
namespace LogicPOS.UI.Components.Modals
{
    public partial class DocumentTypeModal
    {
        ...
        private TextBox _txtAcronym = new TextBox("global_ConfigurationUnitMeasure_Acronym");
        private TextBox _txtPrintCopies = new TextBox("global_print_copies", true, true, RegularExpressions.IntegerNumber);
