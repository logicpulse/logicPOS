...
{
    public partial class VatExemptionReasonModal : EntityModal<VatExemptionReason>
    {
        public VatExemptionReasonModal(EntityModalMode modalMode, VatExemptionReason entity = null) : base(modalMode, entity)
        {
        }
