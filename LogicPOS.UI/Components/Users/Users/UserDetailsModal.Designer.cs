...
namespace LogicPOS.UI.Components.Modals
{
    public partial class UserDetailsModal
    {
        ...
        private TextBox _txtContractDate = new TextBox("global_contract_date");
        ...
        private TextBox _txtFiscalNumber = new TextBox("global_fiscal_number");
        private TextBox _txtLanguage = new TextBox("global_language");
        private TextBox _txtAssignedSeating = new TextBox("global_assigned_seating");
        private TextBox _txtAccessCardNumber = new TextBox("global_access_card_number");
        private TextBox _txtConsumptionBase = new TextBox("global_base_consumption");
        private TextBox _txtBaseOffers = new TextBox("global_base_offers");
        private TextBox _txtPVPOffers = new TextBox("global_price_offers");
