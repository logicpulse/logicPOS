...
{
    internal class DialogUserProfile : EditDialog
    {
        public DialogUserProfile(Window parentWindow, XpoGridView pTreeView, DialogFlags pFlags, DialogMode pDialogMode, Entity pXPGuidObject)
        ...
        private void InitUI()
        {
            try
            {
                ...
                InputFields.Add(new GenericCRUDWidgetXPO(checkButtonAccessPassword, Entity, "AccessPassword"));
