...
namespace LogicPOS.UI.Components.Pages
{
    public partial class PaymentConditionsPage : Page<PaymentCondition>
    {
        ...
        {
            this.Navigator.BtnInsert.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.PaymentConditions.BACKOFFICE_MAN_CONFIGURATIONPAYMENTCONDITION_CREATE);
            this.Navigator.BtnUpdate.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.PaymentConditions.BACKOFFICE_MAN_CONFIGURATIONPAYMENTCONDITION_EDIT);
            this.Navigator.BtnDelete.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.PaymentConditions.BACKOFFICE_MAN_CONFIGURATIONPAYMENTCONDITION_DELETE);
            this.Navigator.BtnView.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.PaymentConditions.BACKOFFICE_MAN_CONFIGURATIONPAYMENTCONDITION_VIEW);
        }
