...
namespace LogicPOS.UI.Components.Pages
{
    public class CustomerTypePage : Page<CustomerType>
    {
        ...
        {
            this.Navigator.BtnInsert.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Customers.Types.BACKOFFICE_MAN_CUSTOMERTYPE_CREATE);
            this.Navigator.BtnUpdate.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Customers.Types.BACKOFFICE_MAN_CUSTOMERTYPE_EDIT);
            this.Navigator.BtnDelete.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Customers.Types.BACKOFFICE_MAN_CUSTOMERTYPE_DELETE);
            this.Navigator.BtnView.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Customers.Types.BACKOFFICE_MAN_CUSTOMERTYPE_VIEW);
        }
