...
namespace LogicPOS.UI.Components.Pages
{
    public class ArticleFamiliesPage : Page<ArticleFamily>
    {
        ...
        {
            this.Navigator.BtnInsert.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Articles.Families.BACKOFFICE_MAN_ARTICLEFAMILY_CREATE);
            this.Navigator.BtnUpdate.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Articles.Families.BACKOFFICE_MAN_ARTICLEFAMILY_EDIT);
            this.Navigator.BtnDelete.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Articles.Families.BACKOFFICE_MAN_ARTICLEFAMILY_DELETE);
            this.Navigator.BtnView.Sensitive = Users.AuthenticationService.UserHasPermission(UserProfilePermissions.Articles.Families.BACKOFFICE_MAN_ARTICLEFAMILY_VIEW);
        }
