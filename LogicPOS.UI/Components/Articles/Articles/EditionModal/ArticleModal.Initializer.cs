...
namespace LogicPOS.UI.Components.Modals
{
    public partial class ArticleModal
    {
        ...
        private void InitializeSubfamiliesComboBox()
        {
            ...
            var labelText = LocalizedString.Instance["global_article_subfamily"];
        ...
        private void InitializeVatExemptionReasonsComboBox()
        {
            ...
            var labelText = LocalizedString.Instance["global_vat_exemption_reason"];
        ...
        {
            var labelText = LocalizedString.Instance["global_article_type"];
        ...
        {
            var labelText = LocalizedString.Instance["global_article_class"];
        ...
        {
            var labelText = LocalizedString.Instance["global_unit_measure"];
        ...
        {
            var labelText = LocalizedString.Instance["global_unit_size"];
        ...
        private void InitializePrinterComboBox()
        {
            ...
            var currentPrinter = _entity != null ? PrinterAssociationService.GetEntityPrinter(_entity.Id) : null;
