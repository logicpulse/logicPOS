    ...
    internal abstract class GenericTreeView<T1, T2> : Box, IGenericTreeView
    {
        ...
        protected void InitUI()
        {
            ...
            if (_showStatusBar)
            {
                ...
                _statusbar.Push(0, GeneralUtils.GetResourceByName("global_statusbar"));
            };
                ...
                try
                {
                    ...
                    if (ShowDialog(newDataSourceRow, DialogMode.Insert))
                    {
                        ...
                        */
                        ...
                        //Utils.ShowMessageTouch(_sourceWindow, DialogFlags.Modal, MessageType.Info, ButtonsType.Ok, CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_information"), "***Record Inserted***");
                    };
                }
                catch (Exception ex)
                {
                    _logger.Error(ex.Message, ex);
                    //Utils.ShowMessageTouch(_sourceWindow, DialogFlags.Modal, MessageType.Error, ButtonsType.Ok, CultureResources.GetCustomResources(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_error"), "***Cant Insert Record***");
                }
            }
        }
            ...
            if (!_skipRecordDelete && _allowRecordDelete)
            {
                ...
                if (response == ResponseType.Yes)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        string message = string.Format(GeneralUtils.GetResourceByName("dialog_message_delete_record_constraint_violation_exception"), _dataSourceRow.GetType().Name);
                        logicpos.Utils.ShowMessageTouch(_sourceWindow, DialogFlags.Modal, MessageType.Error, ButtonsType.Ok, GeneralUtils.GetResourceByName("global_error"), message);
                    }
                }
            }
        }
            ...
            try
            {
                ...
                switch (className)
                {
                    case "erp_customer":
                        ...
                        erp_customer customer = (_dataSourceRow as erp_customer);
                        oid = customer.Oid;
                    ...
                    case "fin_articlefamily":
                        ...
                        fin_articlefamily articleFamily = (_dataSourceRow as fin_articlefamily);
                    ...
                    case "fin_articlesubfamily":
                        ...
                        fin_articlesubfamily articleSubFamily = (_dataSourceRow as fin_articlesubfamily);
                    ...
                    case "fin_warehouse":
                        /* Has an article an invoice issued for it? */
                        fin_warehouse warehouse = (_dataSourceRow as fin_warehouse);
                        oid = warehouse.Oid;
                    ...
                    case "fin_articleclass":
                        /* Has an article an invoice issued for it? */
                        fin_articleclass articleClass = (_dataSourceRow as fin_articleclass);
                    ...
                    case "fin_documentfinancetype":
                        ...
                        fin_documentfinancetype docType = (_dataSourceRow as fin_documentfinancetype);
                        oid = docType.Oid;
                    ...
                    case "pos_configurationplace":
                        ...
                        pos_configurationplace configPlace = (_dataSourceRow as pos_configurationplace);
                        oid = configPlace.Oid;
                    ...
                    case "pos_configurationplacetable":
                        ...
                        pos_configurationplacetable configPlaceTable = (_dataSourceRow as pos_configurationplacetable);
                    ...
                    case "pos_configurationplaceterminal":
                        pos_configurationplaceterminal terminal = (_dataSourceRow as pos_configurationplaceterminal);
                        oid = terminal.Oid;
                    ...
                    case "sys_configurationprinterstemplates":
                        ...
                        sys_configurationprinterstemplates printerTemplate = (_dataSourceRow as sys_configurationprinterstemplates);
                    ...
                    case "sys_configurationprinters":
                        ...
                        sys_configurationprinters printer = (_dataSourceRow as sys_configurationprinters);
                        oid = printer.Oid;
                    ...
                    case "sys_configurationpoledisplay":
                        ...
                        sys_configurationpoledisplay poleDisplay = (_dataSourceRow as sys_configurationpoledisplay);
                        oid = poleDisplay.Oid;
                    ...
                    case "sys_configurationweighingmachine":
                        ...
                        sys_configurationweighingmachine weighingMachine = (_dataSourceRow as sys_configurationweighingmachine);
                    ...
                    case "sys_configurationinputreader":
                        ...
                        sys_configurationinputreader inputReader = (_dataSourceRow as sys_configurationinputreader);
                        oid = inputReader.Oid;
                    ...
                    case "sys_userprofile":
                        ...
                        sys_userprofile userProfile = (_dataSourceRow as sys_userprofile);
                        oid = userProfile.Oid;
                    ...
                    case "erp_customertype":
                        erp_customertype customerType = (_dataSourceRow as erp_customertype);
                    ...
                    case "fin_configurationpaymentcondition":
                        fin_configurationpaymentcondition cfgPaymentContition = (_dataSourceRow as fin_configurationpaymentcondition);
                    ...
                    case "fin_configurationvatrate":
                        fin_configurationvatrate cfgVateRate = (_dataSourceRow as fin_configurationvatrate);
                        oid = cfgVateRate.Oid;
                    ...
                    case "fin_configurationvatexemptionreason":
                        ...
                        fin_configurationvatexemptionreason cfgVateExReason = (_dataSourceRow as fin_configurationvatexemptionreason);
                    ...
                    case "fin_configurationpaymentmethod":
                        fin_configurationpaymentmethod payMethod = (_dataSourceRow as fin_configurationpaymentmethod);
                        oid = payMethod.Oid;
                    ...
                    case "pos_usercommissiongroup":
                        ...
                        pos_usercommissiongroup commissionGrp = (_dataSourceRow as pos_usercommissiongroup);
                    ...
                    case "erp_customerdiscountgroup":
                        ...
                        erp_customerdiscountgroup discountGrp = (_dataSourceRow as erp_customerdiscountgroup);
                        oid = discountGrp.Oid;
                        code = "fin_article";
                ...
                if ((int)countResult > 0)
                {
                    ...
                    _logger.Error("void bool CheckItemForReferences() :: '" + _dataSourceRow.GetType().FullName + "' [" + oid + "] : " + GeneralUtils.GetResourceByName("dialog_message_delete_record_constraint_violation_exception"));
                    logicpos.Utils.ShowMessageTouch(_sourceWindow, DialogFlags.Modal, MessageType.Error, ButtonsType.Ok, GeneralUtils.GetResourceByName("global_error"), string.Format(GeneralUtils.GetResourceByName("dialog_message_delete_record_show_referenced_record_message"), className, code));
                }
                        ...
                        foreach (var column in _columnProperties)
                        {
                            if (column.ResourceString)
                            {
                                ...
                                if (columnValue == "prefparam_culture")
                                {
                                    ...
                                    {
                                        CultureSettings.CurrentCulture = new System.Globalization.CultureInfo(ConfigurationManager.AppSettings["customCultureResourceDefinition"]);
                                        ...
                                        CultureResources.UpdateLanguage(ConfigurationManager.AppSettings["customCultureResourceDefinition"]);
                                    }
                                    else
                                    {
                                    ...
                                    logicpos.Utils.ShowMessageBox(GlobalApp.BackOfficeMainWindow, DialogFlags.Modal, new System.Drawing.Size(600, 400), MessageType.Warning, ButtonsType.Ok, GeneralUtils.GetResourceByName("global_language"), string.Format(GeneralUtils.GetResourceByName("dialog_message_culture_change"), CultureSettings.CurrentCultureName));
        ...
        {
            //Settings
            string fontGenericTreeViewSelectRecordColumnTitle = GeneralSettings.Settings["fontGenericTreeViewSelectRecordColumnTitle"];
            string fontGenericTreeViewSelectRecordColumn = GeneralSettings.Settings["fontGenericTreeViewSelectRecordColumn"];
