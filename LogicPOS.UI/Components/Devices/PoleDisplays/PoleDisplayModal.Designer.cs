...
namespace LogicPOS.UI.Components.PoleDisplays
{
    public partial class PoleDisplayModal
    {
        ...
        private TextBox _txtVendorId = new TextBox("global_pole_display_vid",true,true,@"^0x[\d]{4}$");
        private TextBox _txtProductId = new TextBox("global_pole_display_pid", true, true, @"^0x[\d]{4}$");
        private TextBox _txtEndpoint = new TextBox("global_pole_display_endpoint", true, true, @"^Ep[\d]{2}$");
        private TextBox _txtCOMPort = new TextBox("global_pole_display_com_port", true, true, @"^COM[\d]{1}$");
        private TextBox _txtCodeTable = new TextBox("global_pole_display_codetable", true, true, @"^0x[\d]{2}$");
        private TextBox _txtCharsPerLine = new TextBox("global_pole_display_number_of_characters_per_line", true, true, @"^[\d]+$");
        private TextBox _txtStandByInSeconds = new TextBox("global_pole_display_goto_stand_by_in_seconds", true, true, @"^[\d]+$");
        private TextBox _txtStandByLine1 = new TextBox("global_pole_display_stand_by_line_no");
        private TextBox _txtStandByLine2 = new TextBox("global_pole_display_stand_by_line_no");
