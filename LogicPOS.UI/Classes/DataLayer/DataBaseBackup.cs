...
namespace logicpos.Classes.DataLayer
{
    ...
    internal class DataBaseBackup
    {
            ...
            try
            {
                ...
                if (backupResult)
                {
                    ...
                    if (backupResult)
                    {
                        ...
                        //Post Backup
                        XPOUtility.Audit("DATABASE_BACKUP", string.Format(GeneralUtils.GetResourceByName("audit_message_database_backup"),
        ...
        public static bool Restore(Window parentWindow, string pFileName, string pFileNamePacked, sys_systembackup pSystemBackup)
        {
            ...
            string backupProcess = GeneralUtils.GetResourceByName("global_database_restore");
