...
{filterField} = '{SharedSettings.XpoOidDocumentFinanceTypeCurrentAccountInput}'
        ...
        public void PrintReportRouter(object sender, EventArgs e)
        {
            ...
            if (token.ToString().StartsWith("REPORT_SALES_DETAIL_"))
            {
                ...
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_finance_document") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
                }
                else if (token.ToString() == "REPORT_SALES_DETAIL_PER_DATE")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_date") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
                }
                else if (token.ToString() == "REPORT_SALES_DETAIL_PER_USER")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_user") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
                }
                else if (token.ToString() == "REPORT_SALES_DETAIL_PER_TERMINAL")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_terminal") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
                }
                else if (token.ToString() == "REPORT_SALES_DETAIL_PER_CUSTOMER")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_customer") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
                }
                else if (token.ToString() == "REPORT_SALES_DETAIL_PER_PAYMENT_METHOD")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_payment_method") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
                }
                else if (token.ToString() == "REPORT_SALES_DETAIL_PER_PAYMENT_CONDITION")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_payment_condition") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
                }
                else if (token.ToString() == "REPORT_SALES_DETAIL_PER_CURRENCY")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_currency") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
                }
                else if (token.ToString() == "REPORT_SALES_DETAIL_PER_COUNTRY")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_country") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
                }
                else if (token.ToString() == "REPORT_SALES_DETAIL_GROUP_PER_VAT" || token.ToString() == "REPORT_SALES_PER_VAT")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_vat");
                    reportsQueryDialogMode = ReportsQueryDialogMode.FINANCIAL_DETAIL_VAT;
                }
                else
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "window_title_dialog_report_filter") + resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_detail_postfix");
            ...
            else if (token.ToString().StartsWith("REPORT_SALES_"))
            {
                ...
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_finance_document");
                }
                else if (token.ToString() == "REPORT_SALES_PER_DATE")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_date");
                }

                else if (token.ToString() == "REPORT_SALES_PER_USER")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_user");
                }
                else if (token.ToString() == "REPORT_SALES_PER_TERMINAL")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_terminal");
                }
                else if (token.ToString() == "REPORT_SALES_PER_CUSTOMER")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_customer");
                }
                else if (token.ToString() == "REPORT_SALES_PER_PAYMENT_METHOD")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_payment_method");
                }
                else if (token.ToString() == "REPORT_SALES_PER_PAYMENT_CONDITION")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_payment_condition");
                }
                else if (token.ToString() == "REPORT_SALES_PER_CURRENCY")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_currency");
                }
                else if (token.ToString() == "REPORT_SALES_PER_COUNTRY")
                {
                    this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_sales_per_country");
                }
                else { this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "window_title_dialog_report_filter"); }
            ...
            {
                this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_list_audit_table");
            ...
            {
                this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_customer_balance_details");
            ...
            {
                this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_customer_balance_summary");
            ...
            {
                this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_company_billing");
                reportsQueryDialogMode = ReportsQueryDialogMode.COMPANY_BILLING;
                databaseSourceObject = "view_documentfinancecustomerbalancedetails";
            }
            else if (token.ToString().Equals("REPORT_LIST_USER_COMMISSION"))
            {
                this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_list_user_commission");
            ...
            {
                this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_list_stock_movements");
            ...
            {
                this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_list_stock_warehouse");
            ...
            {
                this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_list_stock_article");
            ...
            {
                this._windowTitle = resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "report_list_stock_supplier");
                ...
                switch (token)
                {
                    case ReportsTypeToken.REPORT_SALES_PER_FINANCE_DOCUMENT:
                        CustomReport.ProcessReportDocumentMasterList(displayMode
                            , resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], token.ToString().ToLower())
