...
namespace logicpos.Classes.Gui.Gtk.Pos.Dialogs
{
    internal class PosLicenceDialog : PosBaseDialog
    {
        ...
        {
            //Init Local Vars
            string windowTitle = CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_license");
        ...
        private void InitUI()
        {
            ...
            Label labelWelcome = new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_license_label_welcome"));
            ...
            //Pack VBoxMain : Info
            Label lableInfo = new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_license_label_info"));
            ...
            //VBoxInnerLeft 
            Label labelInternetRegistration = new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_license_label_internet_registration"));
            ...
            //EntryBoxName
            EntryBoxName = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_name"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryBoxCompany
            EntryBoxCompany = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_company"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryFiscalNumber
            EntryBoxFiscalNumber = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_fiscal_number"), KeyboardMode.Numeric, LogicPOS.Utility.RegexUtils.RegexIntegerGreaterThanZero, true);
            ...
            //EntryBoxAddress
            EntryBoxAddress = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_address"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryBoxEmail
            EntryBoxEmail = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_email"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexEmail, true);
            ...
            //EntryBoxPhone
            EntryBoxPhone = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_phone"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryBoxHardwareId
            _entryBoxHardwareId = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_hardware_id"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryBoxSoftwareKey
            _entryBoxSoftwareKey = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_software_key"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false);
            ...
            //VBoxInnerRight
            Label labelWithoutInternetRegistration = new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_license_label_without_internet_registration"));
            ...
            //Info
            Label labelWithoutInternetContactInfo = new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_license_label_without_internet_contact_info"));
            ...
            //Company
            Label labelWithoutInternetContactCompanyNameLabel = new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_company"));
            ...
            Label labelWithoutInternetContactCompanyPhoneLabel = new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_phone"));
            ...
            //Email
            Label labelWithoutInternetContactCompanyEmailLabel = new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_email"));
            ...
            //Email
            Label labelWithoutInternetContactCompanyWebLabel = new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_website"));
        ...
        private void ActionRegister()
        {
            ...
            {
                logicpos.Utils.ShowMessageTouch(this, DialogFlags.Modal, new System.Drawing.Size(600, 300), MessageType.Error, ButtonsType.Close, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_error"), CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "dialog_message_license_ws_connection_error"));
            ...
            try
            {
                ...
                {
                    logicpos.Utils.ShowMessageTouch(this, DialogFlags.Modal, new System.Drawing.Size(600, 300), MessageType.Error, ButtonsType.Close, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_error"), CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "dialog_message_license_ws_save_license_error"));
                    return;
                }
                else
                {
                    this.Destroy();
                    logicpos.Utils.ShowMessageTouch(this, DialogFlags.Modal, new System.Drawing.Size(600, 300), MessageType.Info, ButtonsType.Close, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_information"), CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "dialog_message_license_aplication_registered"));
                    this.Destroy();
                    Environment.Exit(0);
                }
            }
            catch (Exception ex)
            {
                ...
                logicpos.Utils.ShowMessageTouch(this, DialogFlags.Modal, new System.Drawing.Size(600, 300), MessageType.Error, ButtonsType.Close, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_error"), CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "dialog_message_license_ws_connection_timeout"));
