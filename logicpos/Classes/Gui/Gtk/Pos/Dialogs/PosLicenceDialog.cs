...
namespace logicpos.Classes.Gui.Gtk.Pos.Dialogs
{
    internal class PosLicenceDialog : PosBaseDialog
    {
                    ...
                    : base(pSourceWindow, pDialogFlags)
        {
            ...
            {
                _hardwareId = PluginSettings.PluginLicenceManager.GetHardwareID();
            }
            else
            {
        ...
        private void InitUI()
        {
            ...
            Label labelWelcome = new Label(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "window_license_label_welcome"));
            ...
            //Pack VBoxMain : Info
            Label lableInfo = new Label(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "window_license_label_info"));
            ...
            //VBoxInnerLeft 
            Label labelInternetRegistration = new Label(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "window_license_label_internet_registration"));
            ...
            //EntryBoxName
            EntryBoxName = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_name"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryBoxCompany
            EntryBoxCompany = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_company"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryFiscalNumber
            EntryBoxFiscalNumber = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_fiscal_number"), KeyboardMode.Numeric, LogicPOS.Utility.RegexUtils.RegexIntegerGreaterThanZero, true);
            ...
            //EntryBoxAddress
            EntryBoxAddress = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_address"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryBoxEmail
            EntryBoxEmail = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_email"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexEmail, true);
            ...
            //EntryBoxPhone
            EntryBoxPhone = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_phone"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryBoxHardwareId
            _entryBoxHardwareId = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_hardware_id"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true);
            ...
            //EntryBoxSoftwareKey
            _entryBoxSoftwareKey = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_software_key"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false);
            ...
            //VBoxInnerRight
            Label labelWithoutInternetRegistration = new Label(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "window_license_label_without_internet_registration"));
            ...
            //Info
            Label labelWithoutInternetContactInfo = new Label(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "window_license_label_without_internet_contact_info"));
            ...
            //Company
            Label labelWithoutInternetContactCompanyNameLabel = new Label(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_company"));
            ...
            Label labelWithoutInternetContactCompanyPhoneLabel = new Label(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_phone"));
            ...
            //Email
            Label labelWithoutInternetContactCompanyEmailLabel = new Label(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_email"));
            ...
            //Email
            Label labelWithoutInternetContactCompanyWebLabel = new Label(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_website"));
        ...
        private void ActionRegister()
        {
            ...
            try
            {
                ...
                registredLicence = PluginSettings.PluginLicenceManager.ActivateLicense(
                ...
                string completeFilePath = string.Format("{0}{1}", LicenseRouter.GetCurrentDirectory(), PluginSettings.PluginLicenceManager.GetLicenseFilename());
            ...
            catch (Exception ex)
            {
                ...
                logicpos.Utils.ShowMessageTouch(this, DialogFlags.Modal, new System.Drawing.Size(600, 300), MessageType.Error, ButtonsType.Close, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_error"), CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "dialog_message_license_ws_connection_timeout"));
