    ...
    internal partial class PosCashDrawerDialog : PosBaseDialog
    {
            ...
            : base(pSourceWindow, pDialogFlags, true, false)
        {
            try
            {
                ...
                //Init Local Vars
                string windowTitle = string.Format(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_dialog_cashdrawer"), LogicPOS.Utility.DataConversionUtils.DecimalToStringCurrency(TotalAmountInCashDrawer, SharedSettings.ConfigurationSystemCurrency.Acronym));
                ...
                foreach (SelectStatementResultRow row in xPSelectData.Data)
                {
                    ...
                    touchButtonIconWithText = new TouchButtonIconWithText(
                      ...
                      CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), row.Values[xPSelectData.GetFieldIndex("ResourceString")].ToString()),
                ...
                //EntryAmountMoney
                _entryBoxMovementAmountMoney = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_money"), KeyboardMode.Money, LogicPOS.Utility.RegexUtils.RegexDecimalGreaterEqualThanZero, true);
                ...
                //EntryDescription
                _entryBoxMovementDescription = new EntryBoxValidation(this, CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_description"), KeyboardMode.AlfaNumeric, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false);
