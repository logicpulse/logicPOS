...
namespace logicpos.Classes.Gui.Gtk.Pos.Dialogs
{
      ...
      where T3 : GenericTreeView<T1, T2>, new()
    {
        ...
        public ActionAreaButtons GetDefaultActionAreaButtons()
        {
            ...
            //TouchButtonIconWithText _buttonFilter = ActionAreaButton.FactoryGetDialogButtonType(PosBaseDialogButtonType.Filter, "touchButtonMore_Green", string.Format(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_button_label_filter, SettingsApp.PaginationRowsPerPage), fileActionFilter);
        ...
        public static DataTable GetSelected(Window pSourceWindow)
        {
            ...
            _dialogSelectRecord.CheckBoxToggled += delegate
            {
                ...
                else if (_dialogSelectRecord.GenericTreeViewMode == GenericTreeViewMode.CheckBox)
                {
                    ...
                    //    ? string.Format("{0} : MarkedCheckBoxs:[{1}] : Last:[{2}]", resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_dialog_select_record, _dialogSelectRecord.GenericTreeView.MarkedCheckBoxs, designation) 
                    //    : resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_dialog_select_record
                    //;
                }
            };
