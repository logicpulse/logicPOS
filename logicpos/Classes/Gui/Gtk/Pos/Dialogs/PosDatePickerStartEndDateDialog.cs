...
namespace logicpos.Classes.Gui.Gtk.Pos.Dialogs
{
    internal class PosDatePickerStartEndDateDialog : PosBaseDialog
    {
        ...
        private void InitUI(DialogFlags pDialogFlags, DateTime pDateStart, DateTime pDateEnd)
        {
            ...
            //Init Local Vars
            string windowTitle = CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_dialog_datepicket_startend");
