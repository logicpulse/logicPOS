...
namespace logicpos.Classes.Gui.Gtk.Pos.Dialogs
{
    internal class PosDocumentFinanceArticleDialog : PosBaseDialogGenericTreeView<DataRow>
    {
        ...
        private void InitUI()
        {
            ...
            _entryBoxSelectArticleCode = new XPOEntryBoxSelectRecord<fin_article, TreeViewArticle>(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_article_code"), "Code", "Oid", initialValueSelectArticle, criteriaOperatorSelectArticle);
            ...
            _entryBoxSelectArticleWarehouse = new XPOEntryBoxSelectRecord<fin_articlewarehouse, TreeViewArticleWarehouse>(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_serial_number"), "ArticleSerialNumber", "Oid", _articleWarehouse, criteriaOperatorSelectArticleWarehouse);
            ...
            _entryBoxSelectArticleFamily = new XPOEntryBoxSelectRecord<fin_articlefamily, TreeViewArticleFamily>(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_article_family"), "Designation", "Oid", initialValueSelectArticle.Family, criteriaOperatorSelectArticle);
            ...
            _entryBoxSelectArticleSubFamily = new XPOEntryBoxSelectRecord<fin_articlesubfamily, TreeViewArticleSubFamily>(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_article_subfamily"), "Designation", "Oid", initialValueSelectArticle.SubFamily, criteriaOperatorSelectArticle);
            ...
            //Select Article Name
            _entryBoxSelectArticle = new XPOEntryBoxSelectRecord<fin_article, TreeViewArticle>(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_article"), "Designation", "Oid", initialValueSelectArticle, criteriaOperatorSelectArticle);
            ...
            //Note #1
            //If not Saft Document Type 2, required greater than zero in Price, else we can have zero or greater from Document Type 2 (ex Transportation Guide)
            _entryBoxValidationPriceDisplay = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_price"), KeyboardMode.Money, regExPrice, true);
            ...
            //Quantity
            _entryBoxValidationQuantity = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_quantity"), KeyboardMode.Numeric, _regexDecimalGreaterThanZero, true);
            ...
            //Discount
            _entryBoxValidationDiscount = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_discount"), KeyboardMode.Numeric, _regexPercentage, true);
            ...
            //TotalNet
            _entryBoxValidationTotalNet = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_total_article_tab"), KeyboardMode.None);/* IN009206 */
            ...
            //TotalFinal
            _entryBoxValidationTotalFinal = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_total_per_item_vat"), KeyboardMode.None); /* IN009206 */
            ...
            _entryBoxSelectVatRate = new XPOEntryBoxSelectRecord<fin_configurationvatrate, TreeViewConfigurationVatRate>(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_vat_rate"), "Designation", "Oid", initialValueSelectConfigurationVatRate, criteriaOperatorSelectVatRate);
        ...
        private void _entryBoxSelectArticleCode_ClosePopup(object sender, EventArgs e)
        {
            try
            {
                ...
                if (haveCode != null && haveCode != Guid.Empty)
                {
                    ...
                    {
                        this.WindowTitle = string.Format(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_insert_articles"));
                    ...
                    {
                        logicpos.Utils.ShowMessageTouch(_sourceWindow, DialogFlags.DestroyWithParent, new Size(450, 350), MessageType.Error, ButtonsType.Ok, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "window_title_dialog_already_exited"), CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "article_type_without_price"));
                    }

                }
                else
                {
                    this.WindowTitle = string.Format(CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_insert_articles") + " :: " + CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_new_article"));
                ...
                try
                {
                    foreach (var item in (_posDocumentFinanceDialog.PagePad.Pages[2] as DocumentFinanceDialogPage3).ArticleBag)
                    {
                        if ((item.Key as ArticleBagKey).ArticleOid == Guid.Parse(_dataSourceRow[1].ToString()))
                        {
                            ...
                            {
                                logicpos.Utils.ShowMessageTouch(this, DialogFlags.DestroyWithParent, MessageType.Error, ButtonsType.Ok, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_error"), "Artigo com o nº série: " + _dataSourceRow["SerialNumber"].ToString() + " Já foi inserido");
                                return false;
                            }
                        }
                    }
