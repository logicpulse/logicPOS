...
(
    ...
    Token = 'BANK_TRANSFER' {0}
            ...
            EntryBoxSelectCopyDocumentFinance = new XPOEntryBoxSelectRecordValidation<fin_documentfinancemaster, TreeViewDocumentFinanceMaster>(_sourceWindow, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_copy_finance_document"), "DocumentNumber", "Oid", null, criteriaOperatorCopyDocumentFinance, LogicPOS.Utility.RegexUtils.RegexGuid, false);
            ...
            //Customer Notes
            EntryBoxDocumentMasterNotes = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_notes"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false);

            //Reason
            EntryBoxReason = new EntryBoxValidation(_sourceWindow, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_reason"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtendedForMotive, false);
        ...
        private void UpdateFromDocumentSource(fin_documentfinancemaster sourceDocument)
        {
            try
            {
                ...
                _pagePad2.EntryBoxSelectCustomerFiscalNumber.EntryValidation.Text = (sourceDocument.EntityFiscalNumber != null) ? PluginSettings.PluginSoftwareVendor.Decrypt(sourceDocument.EntityFiscalNumber) : string.Empty;
