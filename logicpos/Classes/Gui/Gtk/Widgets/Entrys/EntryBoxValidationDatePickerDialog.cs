...
namespace logicpos.Classes.Gui.Gtk.Widgets
{
    internal class EntryBoxValidationDatePickerDialog : EntryBoxValidationButton
    {
        ...
        public EntryBoxValidationDatePickerDialog(Window pSourceWindow, string pLabelText, string pRule, bool pRequired)
            :this(pSourceWindow, pLabelText, CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_date"), DataLayerUtils.CurrentDateTimeAtomic(), pRule, pRequired)
        {
        }
