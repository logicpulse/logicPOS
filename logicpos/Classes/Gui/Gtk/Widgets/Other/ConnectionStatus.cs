...
namespace logicpos.Classes.Gui.Gtk.Widgets
{
    public class ConnectionStatus : EventBox
    {
        ...
        public ConnectionStatus(bool pIsConnected)
        {
            ...
            _pixbufStatusOn = logicpos.Utils.FileToPixBuf(PathsSettings.ImagesFolderLocation + @"Icons\Other\connection_status_on.png");
            _pixbufStatusOff = logicpos.Utils.FileToPixBuf(PathsSettings.ImagesFolderLocation + @"Icons\Other\connection_status_off.png");
