...
namespace logicpos.Classes.Gui.Gtk.Widgets
{
    public class NumberPadPin : Box
    {
        ...
        public NumberPadPin(Window pSourceWindow, string pName, Color pButtonColor, string pFont, string pFontLabelStatus, Color pFontColor, Color pFontColorLabelStatus, byte pButtonWidth, byte pButtonHeight, bool pNotLoginAuth, bool pShowSystemButtons = false, bool pVisibleWindow = false, uint pRowSpacingLabelStatus = 20, uint pRowSpacingSystemButtons = 40, byte pPadding = 3)
        {
            ...
            //ResetPassword
            string numberPadPinButtonPasswordResetImageFileName = DataLayerFramework.Path["images"] + @"Icons\Other\pinpad_password_reset.png";
            ...
            //Label Status
            _labelStatus = new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "pos_pinpad_message_type_password"));
            ...
            ButtonKeyOK = new TouchButtonText("touchButtonKeyOK_Green", pButtonColor, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "widget_pospinpad_ok"), pFont, pFontColor, pButtonWidth, pButtonHeight) { Sensitive = false };
            //_buttonKeyResetPassword = new TouchButtonText("touchButtonKeyReset_Red", pButtonColor, resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "widget_pospinpad_change_password, pFont, pFontColor, pButtonWidth, pButtonHeight) { Sensitive = false };
            ...
            if (pShowSystemButtons)
            {
                ...
                ButtonKeyQuit = new TouchButtonText("touchButtonKeyQuit_DarkGrey", pButtonColor, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_quit_title"), pFont, pFontColor, pButtonWidth, pButtonHeight);
            ...
            try
            {
                switch (_mode)
                {
                    ...
                    case NumberPadPinMode.PasswordNew:
                        ...
                        {
                            //Show Error Message
                            ResponseType responseType = logicpos.Utils.ShowMessageTouch(pSourceWindow, DialogFlags.Modal, MessageType.Error, ButtonsType.Ok, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_dialog_change_password"), resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "pos_pinpad_message_password_equal_error"));
                    ...
                    case NumberPadPinMode.PasswordNewConfirm:
                        if (_passwordNew == EntryPin.Text)
                        {
                            ...
                            pUserDetail.Save();
                            SharedUtils.Audit("USER_CHANGE_PASSWORD", string.Format(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "audit_message_user_change_password"), pUserDetail.Name));
                            ResponseType responseType = logicpos.Utils.ShowMessageTouch(pSourceWindow, DialogFlags.Modal, MessageType.Info, ButtonsType.Ok, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_dialog_change_password"), resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "pos_pinpad_message_password_changed"));
                            //Start Application
                            ProcessLogin(pUserDetail);
                            //Finish Job usefull to PosPinDialog send Respond(ResponseType.Ok) when Done
                            result = true;
                            ...
                            //Show Error Message
                            ResponseType responseType = logicpos.Utils.ShowMessageTouch(pSourceWindow, DialogFlags.Modal, MessageType.Error, ButtonsType.Ok, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_dialog_change_password"), resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "pos_pinpad_message_password_confirmation_error"));
                            ClearEntryPinStatusMessage(true);
                            //Return to 
                            _mode = NumberPadPinMode.PasswordNew;
                            UpdateStatusLabels();
        ...
        public bool ValidatePassword(sys_userdetail pUserDetail)
        {
            ...
            try
            {
                ...
                {
                    SharedUtils.Audit("USER_loggerIN_ERROR", string.Format(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "audit_message_user_loggerin_error"), pUserDetail.Name));                    
                    EntryPin.ModifyText(StateType.Normal, Color.Red.ToGdkColor());
                    EntryPin.Text = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "status_message_pin_error");
        ...
        private void UpdateStatusLabels()
        {
            ...
            {
                case NumberPadPinMode.Password:
                    _labelStatus.Text = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "pos_pinpad_message_type_password");
                    //_buttonKeyOK.LabelText = resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "widget_pospinpad_loggerin;
                    ButtonKeyOK.LabelText = (!_notLoginAuth) ? resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "widget_pospinpad_loggerin") : resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "widget_pospinpad_ok");
                    break;
                case NumberPadPinMode.PasswordOld:
                    //Show message to user, to change old password
                    //ResponseType responseType = Utils.ShowMessageTouch(pSourceWindow, DialogFlags.Modal, MessageType.Info, ButtonsType.Ok, resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_dialog_change_password, resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "pos_pinpad_message_password_request_change_password);
                    _labelStatus.Text = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "pos_pinpad_message_type_old_password");
                    ButtonKeyOK.LabelText = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "widget_pospinpad_ok");
                    break;
                case NumberPadPinMode.PasswordNew:
                    _labelStatus.Text = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "pos_pinpad_message_type_new_password");
                    ButtonKeyOK.LabelText = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "widget_pospinpad_ok");
                    break;
                case NumberPadPinMode.PasswordNewConfirm:
                    _labelStatus.Text = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "pos_pinpad_message_type_new_password_confirm");
                    ButtonKeyOK.LabelText = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "widget_pospinpad_ok");
                    break;
                default:
                    break;
        ...
        private void ProcessLogin(sys_userdetail pUserDetail)
        {
            ...
            SharedUtils.Audit("USER_loggerIN", string.Format(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "audit_message_user_loggerin"), pUserDetail.Name));
