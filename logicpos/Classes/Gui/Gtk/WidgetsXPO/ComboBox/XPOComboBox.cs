...
namespace logicpos.Classes.Gui.Gtk.WidgetsXPO
{
    internal class XPOComboBox : ComboBox
    {
        ...
        public void CreateModel(XPCollection pXpCollection, XPGuidObject pCurrentValue, SortProperty pSortProperty = null)
        {
            ...
            tempItemIter = _comboBoxListStore.AppendValues(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "widget_combobox_undefined"), null);
