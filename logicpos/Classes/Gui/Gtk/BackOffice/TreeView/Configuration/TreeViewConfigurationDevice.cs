...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    class TreeViewConfigurationDevice : GenericTreeViewXPO
    {
        ...
        public TreeViewConfigurationDevice(Window pSourceWindow, XPGuidObject pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GenericTreeViewMode pGenericTreeViewMode = GenericTreeViewMode.Default, GenericTreeViewNavigatorMode pGenericTreeViewNavigatorMode = GenericTreeViewNavigatorMode.Default)
        {
            ...
            columnProperties.Add(new GenericTreeViewColumnProperty("Type") { Title = resources.CustomResources.GetCustomResources(GlobalFramework.Settings["customCultureResourceDefinition"], "global_ConfigurationDevice_Type") });
            columnProperties.Add(new GenericTreeViewColumnProperty("PlaceTerminal") { Title = resources.CustomResources.GetCustomResources(GlobalFramework.Settings["customCultureResourceDefinition"], "global_ConfigurationDevice_PlaceTerminal") });
