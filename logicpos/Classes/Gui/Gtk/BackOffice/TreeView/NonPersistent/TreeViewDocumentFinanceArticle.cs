        ...
        public TreeViewDocumentFinanceArticle(Window pSourceWindow, DataRow pDefaultValue, Type pDialogType, GenericTreeViewMode pGenericTreeViewMode = GenericTreeViewMode.Default, GenericTreeViewNavigatorMode pGenericTreeViewNavigatorMode = GenericTreeViewNavigatorMode.Default)
        {
            ...
            List<GenericTreeViewColumnProperty> columnProperties = new List<GenericTreeViewColumnProperty>
            {
                ...
                new GenericTreeViewColumnProperty("Article.Code")
                {
                    ...
                    Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_record_code"),
                    ChildName = "Code",
                    MinWidth = 60,
                    MaxWidth = 150,
                    Alignment = 1.0F,
                ...
                /*02*/
                new GenericTreeViewColumnProperty("Article.Designation") { Type = typeof(fin_article), Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_designation"), ChildName = "Designation", MinWidth = 170, MaxWidth = 170 },
                /*03*/
                new GenericTreeViewColumnProperty("Quantity")
                {
                    Type = typeof(decimal),
                    Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_quantity_acronym"),
                    MinWidth = 70,
                    MaxWidth = 100,
                    Alignment = 1.0F,
                    InitialValue = 1.0m,
                ...
                new GenericTreeViewColumnProperty("Price") { Type = typeof(decimal), Title = string.Format("{0}{1}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_price"), "*"), MinWidth = decimalsColumnWidth, MaxWidth = decimalsColumnWidth, Alignment = 1.0F, CellRenderer = cellRendererCurrency, Visible = false },
                /*05: Visible Display Value, In Current Selected Currency*/
                new GenericTreeViewColumnProperty("PriceDisplay") { Type = typeof(decimal), Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_price"), MinWidth = decimalsColumnWidth, MaxWidth = decimalsColumnWidth, Alignment = 1.0F, CellRenderer = cellRendererCurrency },
                /*06 IN009206*/
                new GenericTreeViewColumnProperty("Discount") { Type = typeof(decimal), Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_discount"), MinWidth = 60, MaxWidth = 60, Alignment = 1.0F, CellRenderer = cellRendererCurrency },
                /*07 IN009206*/
                new GenericTreeViewColumnProperty("VatExemptionReason.Acronym") { Type = typeof(fin_configurationvatexemptionreason), Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_vat_exemption_reason_acronym"), ChildName = "Acronym", MinWidth = 60, MaxWidth = 60, Visible = false },
                /*08*/
                new GenericTreeViewColumnProperty("ConfigurationVatRate.Value")
                {
                    Type = typeof(fin_configurationvatrate),
                    ChildName = "Value",
                    Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_vat_rate"),
                    MinWidth = 60,
                    MaxWidth = 60,
                    Alignment = 1.0F,
                ...
                /*09*/
                new GenericTreeViewColumnProperty("TotalNet") { Type = typeof(decimal), Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_total_article_tab"), MinWidth = decimalsColumnWidth, MaxWidth = decimalsColumnWidth, Alignment = 1.0F, CellRenderer = cellRendererCurrency },
                /*10*/ /* IN009206 */
                new GenericTreeViewColumnProperty("TotalFinal") { Type = typeof(decimal), Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_total_per_item_vat"), MinWidth = decimalsColumnWidth, MaxWidth = decimalsColumnWidth, Alignment = 1.0F, CellRenderer = cellRendererCurrency },
                ...
                /*16*/
                new GenericTreeViewColumnProperty("Article.Family") { Type = typeof(fin_articlefamily), Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_family"), ChildName = "Designation", MinWidth = 60, MaxWidth = 60, Visible = false },
                /*17*/
                new GenericTreeViewColumnProperty("Article.Subfamily") { Type = typeof(fin_articlesubfamily), Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_subfamily"), ChildName = "Designation", MinWidth = 60, MaxWidth = 60, Visible = false },
                /*18*/
                new GenericTreeViewColumnProperty("SerialNumber") { Title = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_serialnumber"), Type = typeof(string), Visible = true },
                /*19*/
