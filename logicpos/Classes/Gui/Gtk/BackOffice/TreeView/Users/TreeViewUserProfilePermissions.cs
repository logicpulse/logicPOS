...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class TreeViewUserProfilePermissions : GenericTreeViewXPO
    {
        ...
        public TreeViewUserProfilePermissions(Window pSourceWindow)
        {
            ...
            {
                new GenericTreeViewColumnProperty("Code") { Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_record_code") },
                new GenericTreeViewColumnProperty("Designation") { Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_user_profiles"), MaxWidth = 150 }
            };
        ...
        new protected void InitUI()
        {
            ...
            TreeViewColumn tmpColProperty = _treeViewPermissionItem.AppendColumn(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_privilege_property"), new CellRendererText() { FontDesc = _fontDesc }, "text", 1);
            //Config Column Title
            ...
            TreeViewColumn tmpColActivo = _treeViewPermissionItem.AppendColumn(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_privilege_active"), _cellRendererTogglePermissionItem, "active", 2);
