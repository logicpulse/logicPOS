...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class TreeViewDocumentFinancePayment : GenericTreeViewXPO
    {
        ...
        public TreeViewDocumentFinancePayment(Window pSourceWindow, XPGuidObject pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GenericTreeViewMode pGenericTreeViewMode = GenericTreeViewMode.Default, GenericTreeViewNavigatorMode pGenericTreeViewNavigatorMode = GenericTreeViewNavigatorMode.Default)
        {
            ...
            {
                new GenericTreeViewColumnProperty("CreatedAt") { Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_document_date"), MinWidth = 140 }, /* IN009067 */
                new GenericTreeViewColumnProperty("PaymentRefNo") { Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_document_number"), MinWidth = 120 }, /* IN009067 */
                new GenericTreeViewColumnProperty("PaymentStatus") { Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_document_status"), MinWidth = 50, MaxWidth = 50 }
            };
            //Shared Query
            ...
            {
                Title = CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_total"),
                MinWidth = 100,
                //Alignment = 1.0F,
