...
{
    internal class TreeViewCustomerDiscountGroup : GenericTreeViewXPO
    {
        //Public Parametless Constructor Required by Generics
        public TreeViewCustomerDiscountGroup() { }

        public TreeViewCustomerDiscountGroup(Window pSourceWindow)
            : this(pSourceWindow, null, null, null) { }

        //XpoMode
        public TreeViewCustomerDiscountGroup(Window pSourceWindow, XPGuidObject pDefaultValue, CriteriaOperator pXpoCriteria, Type pDialogType, GenericTreeViewMode pGenericTreeViewMode = GenericTreeViewMode.Default, GenericTreeViewNavigatorMode pGenericTreeViewNavigatorMode = GenericTreeViewNavigatorMode.Default)
        {
            //Init Vars
