...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogArticleSubFamily : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_edit_articlesubfamily"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxFamily = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_families"), xpoComboBoxFamily);
                ...
                BOWidgetBox boxVatOnTable = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_vat_on_table"), xpoComboBoxVatOnTable);
                ...
                BOWidgetBox boxVatDirectSelling = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_vat_direct_selling"), xpoComboBoxVatDirectSelling);
                ...
                //Append Tab
                _notebook.AppendPage(vboxTab2, new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "dialog_edit_articlesubfamily_tab2_label")));
            }
