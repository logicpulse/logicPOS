...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogArticleSubFamily : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_articlesubfamily"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxButtonLabel = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_button_name"), entryButtonLabel);
                ...
                BOWidgetBox boxFamily = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_families"), xpoComboBoxFamily);
                ...
                BOWidgetBox boxfileChooserButtonImage = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_button_image"), fileChooserButtonImage);
                ...
                BOWidgetBox boxPrinter = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_device_printer"), xpoComboBoxPrinter);
                ...
                BOWidgetBox boxTemplate = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationPrintersTemplates"), xpoComboBoxTemplate);
                ...
                BOWidgetBox boxDiscountGroup = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_discount_group"), xpoComboBoxDiscountGroup);
                ...
                BOWidgetBox boxVatOnTable = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_vat_on_table"), xpoComboBoxVatOnTable);
                ...
                BOWidgetBox boxVatDirectSelling = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_vat_direct_selling"), xpoComboBoxVatDirectSelling);
                ...
                //Append Tab
                _notebook.AppendPage(vboxTab2, new Label(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "dialog_edit_articlesubfamily_tab2_label")));
            }
