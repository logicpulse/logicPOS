...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogArticleFamily : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(DataLayerFramework.Settings["customCultureResourceDefinition"], "window_title_edit_articlefamily"));
