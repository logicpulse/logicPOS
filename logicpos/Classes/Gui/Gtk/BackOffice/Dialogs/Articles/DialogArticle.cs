    ...
    internal class DialogArticle : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            ...
            try
            {
                ...
                //BOWidgetBox boxComposite = new BOWidgetBox(CultureResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_composite_article"), _xpoComboBoxCompositeArticle);
