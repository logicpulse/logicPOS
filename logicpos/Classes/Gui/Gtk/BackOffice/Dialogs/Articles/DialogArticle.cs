...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogArticle : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_edit_article"));
        ...
        private void InitUI()
        {
            ...
            try
            {
                ...
                BOWidgetBox boxCodeDealer = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_record_code_dealer"), entryCodeDealer);
                ...
                BOWidgetBox boxButtonLabel = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_button_name"), entryButtonLabel);
                ...
                //BOWidgetBox boxComposite = new BOWidgetBox(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), _xpoComboBoxCompositeArticle);
                ...
                BOWidgetBox boxFamily = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_family"), _xpoComboBoxFamily);
                ...
                BOWidgetBox boxSubFamily = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_subfamily"), _xpoComboBoxSubFamily);
                ...
                BOWidgetBox boxType = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_type"), xpoComboBoxType);
                ...
                BOWidgetBox boxfileChooserButtonImage = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_button_image"), fileChooserButtonImage);
                ...
                //Artigos Compostos [IN:016522]
                //Composite
                _checkButtonComposite = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"));
                ...
                _checkButtonUniqueArticles = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_unique_articles"));
                ...
                //Favorite
                CheckButton checkButtonFavorite = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_favorite"));
                ...
                //UseWeighingBalance
                CheckButton checkButtonUseWeighingBalance = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_use_weighing_balance"));
                ...
                Label labelPriceNormal = new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "article_normal_price")) { WidthRequest = col2width };
                Label labelPricePromotion = new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "article_promotion_price")) { WidthRequest = col3width };
                Label labelPriceUsePromotionPrice = new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "article_use_promotion_price")) { WidthRequest = col4width };
                ...
                //PVPVariable
                CheckButton checkButtonPVPVariable = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_variable_price"));
                ...
                //PriceWithVat
                CheckButton checkButtonPriceWithVat = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_price_with_vat"));
                ...
                BOWidgetBox boxDiscount = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_discount"), entryDiscount);
                ...
                BOWidgetBox boxClass = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_class"), xpoComboBoxClass);
                ...
                if (DataLayerSettings.IsDefaultTheme)/* IN008024 */
                {
                    ...
                    BOWidgetBox boxVatOnTable = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_vat_on_table"), _xpoComboBoxVatOnTable);
                ...
                BOWidgetBox boxVatDirectSelling = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_vat_direct_selling"), _xpoComboBoxVatDirectSelling);
                ...
                BOWidgetBox boxVatExemptionReason = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_vat_exemption_reason"), _xpoComboBoxVatExemptionReason);
                ...
                //Append Tab
                _notebook.AppendPage(_vboxTab2, new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "dialog_edit_article_tab2_label")));
                ...
                BOWidgetBox boxBarCode = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_barcode"), entryBarCode);
                ...
                BOWidgetBox boxAccounting = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_total_stock"), entryAccounting);
                ...
                BOWidgetBox boxMinimumStock = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_minimum_stock"), entryMinimumStock);
                ...
                BOWidgetBox boxTare = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_tare"), entryTare);
                ...
                BOWidgetBox boxWeight = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_weight"), entryWeight);
                ...
                BOWidgetBox boxDefaultQuantity = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_default_quantity"), entryDefaultQuantity);
                ...
                BOWidgetBox boxUnitMeasure = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_unit_measure"), xpoComboBoxUnitMeasure);
                ...
                BOWidgetBox boxUnitSize = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_unit_size"), xpoComboBoxUnitSize);
                ...
                BOWidgetBox boxPrinter = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_device_printer"), xpoComboBoxPrinter);
                ...
                BOWidgetBox boxTemplate = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_ConfigurationPrintersTemplates"), xpoComboBoxTemplate);
                ...
                BOWidgetBox boxTemplateBarCode = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_ConfigurationPrintersBarCodeTemplates"), xpoComboBoxTemplateBarCode);
                ...
                if (GlobalApp.ScreenSize.Width > 800 && GlobalApp.ScreenSize.Height > 600)
                {
                    ...
                    BOWidgetBox boxCommissionGroup = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_commission_group"), xpoComboBoxCommissionGroup);
                    ...
                    BOWidgetBox boxDiscountGroup = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_discount_group"), xpoComboBoxDiscountGroup);
                ...
                //Append Tab
                _notebook.AppendPage(vboxTab3, new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "dialog_edit_article_tab3_label")));
                ...
                _notebook.AppendPage(_scrolledWindowCompositionView, new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "dialog_edit_article_tab4_label1")));
                ...
                _entryBoxSelectArticle1 = new XPOEntryBoxSelectRecordValidation<fin_article, TreeViewArticle>(this, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article"), "Designation", "Oid", _article, criteriaOperatorSelectArticle, Enums.Keyboard.KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true, true, "", LogicPOS.Utility.RegexUtils.RegexDecimalGreaterThanZero, _totalCompositeEntrys);
                ...
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(_entryBoxSelectArticle1.EntryCodeValidation, _dataSourceRow, string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), _totalCompositeEntrys, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_code")), LogicPOS.Utility.RegexUtils.RegexAlfaNumericArticleCode, true));
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(_entryBoxSelectArticle1.EntryValidation, _dataSourceRow, string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), _totalCompositeEntrys, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_designation")), LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true));
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(_entryBoxSelectArticle1.EntryQtdValidation, _dataSourceRow, string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), _totalCompositeEntrys, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_quantity")), LogicPOS.Utility.RegexUtils.RegexDecimalGreaterThanZero, true));

                _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), _totalCompositeEntrys, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_code"))) as GenericCRUDWidgetXPO);
                if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;

                _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), _totalCompositeEntrys, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_designation"))) as GenericCRUDWidgetXPO);
                if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;

                _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), _totalCompositeEntrys, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_quantity"))) as GenericCRUDWidgetXPO);
                if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;
                ...
                _notebook.AppendPage(_scrolledWindowSerialNumbersView, new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_serial_number")));
            ...
            try
            {
                foreach (fin_articlecomposition articleLine in _article.ArticleComposition)
                {
                    ...
                    if (_entryBoxSelectArticle1.Value == null)
                    {
                        ...
                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), 1, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_code"))) as GenericCRUDWidgetXPO);
                        _genericCRUDWidgetXPO.Validated = true;

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), 1, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_designation"))) as GenericCRUDWidgetXPO);
                        _genericCRUDWidgetXPO.Validated = true;

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), 1, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_quantity"))) as GenericCRUDWidgetXPO);
        ...
        private void SelectRecordDropDownArticle(bool isArticleCode, XPOEntryBoxSelectRecordValidation<fin_article, TreeViewArticle> pXPOEntry)
        {
            try
            {
                ...
                if (!articleOid.Equals(Guid.Empty))
                {
                    ...
                    if (isArticleCode)
                    {
                        pXPOEntry.EntryValidation.Text = (newArticle != null) ? newArticle.Designation.ToString() : resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_error");

                        var childQuantity = (pXPOEntry.Value.DefaultQuantity > 0) ? pXPOEntry.Value.DefaultQuantity : 1;

                        pXPOEntry.EntryQtdValidation.Text = (newArticle != null) ? string.Format("{0:0.##}", childQuantity) : resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_error");
                        ...
                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), pXPOEntry.EntryNumber, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_code"))) as GenericCRUDWidgetXPO);
                        _genericCRUDWidgetXPO.Validated = true;

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), pXPOEntry.EntryNumber, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_designation"))) as GenericCRUDWidgetXPO);
                        _genericCRUDWidgetXPO.Validated = true;

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), pXPOEntry.EntryNumber, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_quantity"))) as GenericCRUDWidgetXPO);
                    ...
                    pXPOEntry.EntryCodeValidation.Text = (newArticle != null) ? newArticle.Code.ToString() : resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_error");

                    decimal quantity = (pXPOEntry.Value.DefaultQuantity > 0) ? pXPOEntry.Value.DefaultQuantity : 1;

                    pXPOEntry.EntryQtdValidation.Text = (newArticle != null) ? string.Format("{0:0.##}", quantity) : resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_error");
                    ...
                    if (pXPOEntry.Value == _article)
                    {
                        ...
                        logicpos.Utils.ShowMessageNonTouch(this, DialogFlags.DestroyWithParent, MessageType.Warning, ButtonsType.Ok, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "dialog_message_composite_article_same"), resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"));
                    ...
                    if (_article.ArticleComposition.Count > 0)
                    {
                        foreach (var line in _article.ArticleComposition)
                        {
                            if (line.ArticleChild == pXPOEntry.Value)
                            {
                                ...
                                logicpos.Utils.ShowMessageNonTouch(this, DialogFlags.DestroyWithParent, MessageType.Warning, ButtonsType.Ok, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "dialog_message_composite_article_already"), resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"));
                                return;
                            }
                        }
                    }
        ...
        private void NewBox_AddNewEntryAndPopulate(fin_articlecomposition pArticleComposition)
        {
            try
            {
                ...
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(_entryBoxSelectArticle1.EntryCodeValidation, _dataSourceRow, string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), NewEntryBoxSelectArticle.EntryNumber, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_code")), "", true));
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(_entryBoxSelectArticle1.EntryValidation, _dataSourceRow, string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), NewEntryBoxSelectArticle.EntryNumber, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_designation")), LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true));
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(_entryBoxSelectArticle1.EntryQtdValidation, _dataSourceRow, string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), NewEntryBoxSelectArticle.EntryNumber, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_quantity")), LogicPOS.Utility.RegexUtils.RegexDecimalGreaterThanZero, true));
        ...
        private void NewBox_AddNewEntryEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                CriteriaOperator criteriaOperatorSelectArticle = CriteriaOperator.Parse(string.Format("(Disabled IS NULL OR Disabled  <> 1)"));
                if (_article != null) { criteriaOperatorSelectArticle = CriteriaOperator.Parse(string.Format("(Disabled IS NULL OR Disabled  <> 1) AND Oid != '{0}'", _article.Oid.ToString())); }
                XPOEntryBoxSelectRecordValidation<fin_article, TreeViewArticle> NewEntryBoxSelectArticle = new XPOEntryBoxSelectRecordValidation<fin_article, TreeViewArticle>(this, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article"), "Designation", "Oid", _article, criteriaOperatorSelectArticle, Enums.Keyboard.KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, true, true, LogicPOS.Utility.RegexUtils.RegexAlfaNumericArticleCode, LogicPOS.Utility.RegexUtils.RegexDecimalGreaterThanZero, _totalCompositeEntrys);
            ...
            try
            {
                ...
                if (entrySelected != null)
                {
                    ...
                    else
                    {
                        ...
                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), entrySelected.EntryNumber, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_code"))) as GenericCRUDWidgetXPO);
                        _crudWidgetList.Remove(_genericCRUDWidgetXPO);

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), entrySelected.EntryNumber, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_designation"))) as GenericCRUDWidgetXPO);
                        _crudWidgetList.Remove(_genericCRUDWidgetXPO);

                        _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), entrySelected.EntryNumber, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_quantity"))) as GenericCRUDWidgetXPO);
                        _crudWidgetList.Remove(_genericCRUDWidgetXPO);
                ...
                if (entrySelected.Value != null)
                {
                    if (_article.ArticleComposition.Count > 0 && Convert.ToDecimal(entrySelected.EntryQtdValidation.Text) > 0)
                    {
                        foreach (fin_articlecomposition articleLine in _article.ArticleComposition)
                        {
                            ...
                            {
                                articleLine.Quantity = SharedUtils.StringToDecimal(entrySelected.EntryQtdValidation.Text);
                                return;
                            }
                        }
                    }
        ...
        private void CheckButtonComposite_Toggled(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), i, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_article_code"))) as GenericCRUDWidgetXPO);
                    if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;

                    _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), i, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_designation"))) as GenericCRUDWidgetXPO);
                    if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;

                    _genericCRUDWidgetXPO = (this._crudWidgetList.GetFieldWidget(string.Format("{0} linha {1}: {2}", resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_composite_article"), i, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_quantity"))) as GenericCRUDWidgetXPO);
                    if (_genericCRUDWidgetXPO != null) _genericCRUDWidgetXPO.Validated = true;
                }
            }
        }
        ...
        private void PopulateSerialNumberArticleEntrys(XPGuidObject pDataSourceRow)
        {
            try
            {
                ...
                if (pDataSourceRow != null && ((pDataSourceRow as fin_articleserialnumber).StockMovimentIn == null || (pDataSourceRow as fin_articleserialnumber).StockMovimentIn.Oid == Guid.Empty))
                {
                    ...
                    (pDataSourceRow as fin_articleserialnumber).StockMovimentIn.DocumentNumber = resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_internal_moviment");
                ...
                BOWidgetBox boxSerialNumber = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_serial_number"), entrySerialNumber);
                ...
                BOWidgetBox boxWareHouse = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_warehouse"), xpoComboBoxWarehouse);
                ...
                BOWidgetBox boxWareHouseLocation = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_ConfigurationDevice_PlaceTerminal"), xpoComboBoxWarehouseLocation);
        ...
        private void ButtonClearSerialNumber_Clicked(object sender, EventArgs e)
        {
            try
            {
                ResponseType responseType = logicpos.Utils.ShowMessageNonTouch(this, DialogFlags.DestroyWithParent, MessageType.Question, ButtonsType.YesNo, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "dialog_message_delete_record"), string.Format(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_warning"), SharedFramework.ServerVersion));
