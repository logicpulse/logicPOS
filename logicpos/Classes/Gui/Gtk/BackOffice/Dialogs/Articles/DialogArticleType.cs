...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogArticleType : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_articletype"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                //HavePrice
                CheckButton checkButtonHavePrice = new CheckButton(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_articletype_haveprice"));
