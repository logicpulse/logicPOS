...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    class DialogArticleClass : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResources(GlobalFramework.Settings["customCultureResourceDefinition"], "window_title_edit_dialog_article_class"));
