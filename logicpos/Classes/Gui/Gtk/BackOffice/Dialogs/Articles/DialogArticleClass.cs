...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogArticleClass : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_dialog_article_class"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                //WorkInStock
                CheckButton checkButtonWorkInStock = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_work_in_stock"));
