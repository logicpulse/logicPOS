    ...
    internal class DialogDocumentFinanceSeries : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxFiscalYear = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_documentfinance_series"), xpoComboBoxFiscalYear);
                ...
                BOWidgetBox boxNextDocumentNumber = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_documentfinanceseries_NextDocumentNumber"), entryNextDocumentNumber);
                ...
                BOWidgetBox boxDocumentNumberRangeBegin = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_documentfinanceseries_DocumentNumberRangeBegin"), entryDocumentNumberRangeBegin);
                ...
                BOWidgetBox boxDocumentNumberRangeEnd = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_documentfinanceseries_DocumentNumberRangeEnd"), entryDocumentNumberRangeEnd);
