    ...
    internal class DialogDocumentFinanceYearSerieTerminal : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxFiscalYear = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_fiscal_year"), xpoComboBoxFiscalYear);
                ...
                BOWidgetBox boxDocumentType = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_documentfinance_type"), xpoComboBoxDocumentType);
                ...
                BOWidgetBox boxSerie = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_documentfinance_series"), xpoComboBoxSerie);
                ...
                BOWidgetBox boxTerminal = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_configurationplaceterminal"), xpoComboBoxTerminal);
                ...
                BOWidgetBox boxPrinter = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_configurationprinter"), xpoComboBoxPrinter);
                ...
                BOWidgetBox boxTemplate = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_configurationprintersTemplate"), xpoComboBoxTemplate);
