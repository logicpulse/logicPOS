    ...
    internal class DialogDocumentFinanceType : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxPrintCopies = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_print_copies"), entryPrintCopies);
                ...
                CheckButton checkButtonPrintRequestConfirmation = new CheckButton(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_print_request_confirmation"));
                ...
                //PrintOpenDrawer
                CheckButton checkButtonPrintOpenDrawer = new CheckButton(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_open_drawer"));
