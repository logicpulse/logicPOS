    ...
    internal class DialogDocumentFinanceType : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxPrintCopies = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_print_copies"), entryPrintCopies);
                ...
                CheckButton checkButtonPrintRequestConfirmation = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_print_request_confirmation"));
                ...
                //PrintOpenDrawer
                CheckButton checkButtonPrintOpenDrawer = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_open_drawer"));
