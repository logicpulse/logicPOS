...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogCustomerDiscountGroup : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResources(GlobalFramework.Settings["customCultureResourceDefinition"], "window_title_edit_customerdiscountgroup"));
