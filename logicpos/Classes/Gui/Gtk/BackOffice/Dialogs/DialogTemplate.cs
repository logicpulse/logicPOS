...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogTemplate : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_edit_template"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxNotes = new BOWidgetBox(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_notes"), entryNotes);
                ...
                BOWidgetBox boxCreatedAt = new BOWidgetBox(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_date"), entryCreatedAt);
                ...
                BOWidgetBox boxUpdatedAt = new BOWidgetBox(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_date"), entryUpdatedAt);
                ...
                BOWidgetBox boxCreatedBy = new BOWidgetBox(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_user, xpoComboBoxCreatedBy);
                ...
                BOWidgetBox boxCreatedWhere = new BOWidgetBox(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_terminal, xpoComboBoxCreatedWhere);
                ...
                BOWidgetBox boxfileChooserButtonImage = new BOWidgetBox(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_button_image, fileChooserButtonImage);
                ...
                Label labelMultilineNotes = new Label(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_notes);
                ...
                //Append Tab
                _notebook.AppendPage(vboxTab2, new Label(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_notes));
                */
