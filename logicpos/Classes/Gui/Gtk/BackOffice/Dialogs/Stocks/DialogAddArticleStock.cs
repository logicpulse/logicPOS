...
namespace logicpos.Classes.Gui.Gtk.Pos.Dialogs
{
    internal class DialogAddArticleStock : BOBaseDialog
    {
        ...
        {
            //Init Local Vars
            string windowTitle = CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_dialog_article_stock");
        ...
        private void InitUI()
        {
            try
            {
                ...
                //DocumentDate
                _entryBoxDocumentDate = new EntryBoxValidationDatePickerDialog(this, CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_date"), CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_date"), _initialDocumentDate, LogicPOS.Utility.RegexUtils.RegexDate, true, LogicPOS.Settings.CultureSettings.DateFormat, true);
                ...
                _entryBoxDocumentNumber = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_document_number"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false, true);
                ...
                _entryBoxSerialNumber1 = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_serial_number"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false, true);
                ...
                //Price
                _entryBoxPrice1 = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_price"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexDecimalGreaterEqualThanZeroFinancial, false, true);
                ...
                BOWidgetBox boxWareHouse = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_warehouse"), xpoComboBoxWarehouse);
                ...
                BOWidgetBox boxWareHouseLocation = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationDevice_PlaceTerminal"), xpoComboBoxWarehouseLocation);
                xpoComboBoxWarehouseLocation.Changed += XpoComboBoxWarehouselocation_Changed;

                //Unique Articles (Have multi S/N)
                CheckButton _checkButtonUniqueArticles = new CheckButton(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_unique_articles"));
                ...
                //Notes
                _entryBoxNotes = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_notes"), KeyboardMode.Alfa, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false, true);
            ...
            try
            {
                ...
                if (!articleOid.Equals(Guid.Empty))
                {
                    ...
                    if (isArticleCode)
                    {
                        ...
                        pXPOEntry.EntryValidation.Text = (newArticle != null) ? newArticle.Designation.ToString() : CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_error");

                        pXPOEntry.EntryValidation.Changed += delegate { pXPOEntry.EntryValidation.Validate(); };

                        pXPOEntry.EntryQtdValidation.Text = (newArticle != null) ? string.Format("{0:0.##}", newArticle.DefaultQuantity) : CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_error");
                    ...
                    pXPOEntry.EntryCodeValidation.Text = (newArticle != null) ? newArticle.Code.ToString() : CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_error");
        ...
        private void NewBox_AddNewEntryEvent(object sender, EventArgs e)
        {
            try
            {
                ...
                //SerialNumber
                EntryBoxValidation NewEntryBoxSerialNumber = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_serial_number"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexAlfaNumericExtended, false, true);
                ...
                //Price
                EntryBoxValidation NewEntryBoxPrice = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_price"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexDecimalGreaterEqualThanZeroFinancial, false, true);
        ...
        private void EntrySerialNumberValidation_Changed(object sender, EventArgs e)
        {
            try
            {
                ...
                if((_collectionSavedArticleSerialNumber != null && _collectionSavedArticleSerialNumber.Count > 0) || (_serialNumbersInCache.ContainsValue(entrySerialNumber.Text)))
                {
                    ...
                    entrySerialNumber.TooltipText = CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_serial_number") + " já existe!";
                ...
                else
                {
                    ...
                    entrySerialNumber.TooltipText = CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_serial_number");
                }
