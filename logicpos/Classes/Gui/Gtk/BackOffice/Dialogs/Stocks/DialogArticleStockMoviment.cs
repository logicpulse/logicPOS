    ...
    internal class DialogArticleStockMoviment : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                //Quantity
                _entryBoxQuantity = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_quantity"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexDecimal, false, true);
                ...
                //Price
                _entryBoxPrice1 = new EntryBoxValidation(this, CultureResources.GetResourceByLanguage(GeneralSettings.Settings.GetCultureName(), "global_price"), KeyboardMode.None, LogicPOS.Utility.RegexUtils.RegexDecimal, false, true);
