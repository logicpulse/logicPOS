...
namespace logicpos.Classes.Gui.Gtk.BackOffice.Dialogs.Configuration
{
    internal class DialogConfigurationWarehouse : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_warehouse"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxOrd = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_record_order"), entryOrd);
                ...
                //Default
                CheckButton checkButtonDefault = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_default_warehouse"));
                ...
                //Append Tab
                _notebook.AppendPage(_scrolledWindow, new Label(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_locations")));
            }
        ...
        private void PopulateWarehouseLocationEntrys(XPGuidObject pDataSourceRow)
        {
            try
            {
                ...
                BOWidgetBox boxLocation = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationDevice_PlaceTerminal"), entryLocation);
