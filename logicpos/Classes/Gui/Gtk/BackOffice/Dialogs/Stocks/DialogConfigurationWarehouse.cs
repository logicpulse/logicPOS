...
namespace logicpos.Classes.Gui.Gtk.BackOffice.Dialogs.Configuration
{
    internal class DialogConfigurationWarehouse : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(GeneralSettings.Settings.GetCultureName(), "global_warehouse"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxOrd = new BOWidgetBox(CultureResources.GetLanguageResource(GeneralSettings.Settings.GetCultureName(), "global_record_order"), entryOrd);
                ...
                //Default
                CheckButton checkButtonDefault = new CheckButton(CultureResources.GetLanguageResource(GeneralSettings.Settings.GetCultureName(), "global_default_warehouse"));
                ...
                //Append Tab
                _notebook.AppendPage(_scrolledWindow, new Label(CultureResources.GetLanguageResource(GeneralSettings.Settings.GetCultureName(), "global_locations")));
            }
        ...
        private void PopulateWarehouseLocationEntrys(XPGuidObject pDataSourceRow)
        {
            try
            {
                ...
                BOWidgetBox boxLocation = new BOWidgetBox(CultureResources.GetLanguageResource(GeneralSettings.Settings.GetCultureName(), "global_ConfigurationDevice_PlaceTerminal"), entryLocation);
