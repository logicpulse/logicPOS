...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationPoleDisplay : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_configurationpoledisplay"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxVID = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_pole_display_vid"), entryVID);
                ...
                BOWidgetBox boxPID = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_pole_display_pid"), entryPID);
                ...
                BOWidgetBox boxEndPoint = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_pole_display_endpoint"), entryEndPoint);
                ...
                BOWidgetBox boxCOM = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_pole_display_com_port"), entryCOM);
                ...
                BOWidgetBox boxCodeTable = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_pole_display_codetable"), entryCodeTable);
                ...
                BOWidgetBox boxDisplayCharactersPerLine = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_pole_display_number_of_characters_per_line"), entryDisplayCharactersPerLine);
                ...
                BOWidgetBox boxGoToStandByInSeconds = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_pole_display_goto_stand_by_in_seconds"), entryGoToStandByInSeconds);
                ...
                BOWidgetBox boxStandByLine1 = new BOWidgetBox(string.Format(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_pole_display_stand_by_line_no"), 1), entryStandByLine1);
                ...
                BOWidgetBox boxStandByLine2 = new BOWidgetBox(string.Format(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_pole_display_stand_by_line_no"), 2), entryStandByLine2);
