    ...
    internal class DialogConfigurationPrintersType : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxToken = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_DialogConfigurationPrintersTypetoken"), entryToken);
                ...
                //ThermalPrinter
                CheckButton checkButtonThermalPrinter = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_printer_thermal_printer"));
