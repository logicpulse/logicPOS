...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationPrintersType : BOBaseDialog
    {
            ...
            : base(pSourceWindow, pTreeView, pFlags, pDialogMode, pXPGuidObject)
        {
            ...
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_dialogconfigurationprinterstype"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxToken = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_DialogConfigurationPrintersTypetoken"), entryToken);
                ...
                //ThermalPrinter
                CheckButton checkButtonThermalPrinter = new CheckButton(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_printer"));
