...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    class DialogConfigurationCurrency : BOBaseDialog
    {
        ...
        {
            this.Title = Utils.GetWindowTitle(Resx.window_title_edit_configurationcurrency);
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxAcronym = new BOWidgetBox(Resx.global_ConfigurationCurrency_Acronym, entryAcronym);
                ...
                BOWidgetBox boxEntity = new BOWidgetBox(Resx.global_ConfigurationCurrency_Entity, entryEntity);
                ...
                BOWidgetBox boxExchangeRate = new BOWidgetBox(Resx.global_exchangerate, entryExchangeRate);
