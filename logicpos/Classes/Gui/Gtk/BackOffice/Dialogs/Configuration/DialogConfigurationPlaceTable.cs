    ...
    internal class DialogConfigurationPlaceTable : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxPlace = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_place"), xpoComboBoxPlace);
                vboxTab1.PackStart(boxPlace, false, false, 0);
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(boxPlace, DataSourceRow, "Place", LogicPOS.Utility.RegexUtils.RegexGuid, true));
                ...
                if (_dataSourceRow != null && (_dataSourceRow as pos_configurationplacetable).Oid == POSSettings.XpoOidConfigurationPlaceTableDefaultOpenTable) checkButtonDisabled.Sensitive = false;
