...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationCashRegister : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "window_title_edit_configurationcashregister"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxPrinter = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_ConfigurationCashRegister_Printer"), entryPrinter);
                vboxTab1.PackStart(boxPrinter, false, false, 0);
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(boxPrinter, _dataSourceRow, "Printer", SharedSettings.RegexAlfaNumeric, false));

                //Drawer
                Entry entryDrawer = new Entry();
                BOWidgetBox boxDrawer = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_ConfigurationCashRegister_Drawer"), entryDrawer);
                vboxTab1.PackStart(boxDrawer, false, false, 0);
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(boxDrawer, _dataSourceRow, "Drawer", SharedSettings.RegexAlfaNumeric, false));

                //AutomaticDrawer
                Entry entryAutomaticDrawer = new Entry();
                BOWidgetBox boxAutomaticDrawer = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_ConfigurationCashRegister_AutomaticDrawer"), entryAutomaticDrawer);
                vboxTab1.PackStart(boxAutomaticDrawer, false, false, 0);
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(boxAutomaticDrawer, _dataSourceRow, "AutomaticDrawer", SharedSettings.RegexAlfaNumeric, false));

                //ActiveSales
                Entry entryActiveSales = new Entry();
                BOWidgetBox boxActiveSales = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_ConfigurationCashRegister_ActiveSales"), entryActiveSales);
                vboxTab1.PackStart(boxActiveSales, false, false, 0);
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(boxActiveSales, _dataSourceRow, "ActiveSales", SharedSettings.RegexAlfaNumeric, false));
                
                //AllowChargeBacks
                Entry entryAllowChargeBacks = new Entry();
                BOWidgetBox boxAllowChargeBacks = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_ConfigurationCashRegister_AllowChargeBacks"), entryAllowChargeBacks);
                vboxTab1.PackStart(boxAllowChargeBacks, false, false, 0);
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(boxAllowChargeBacks, _dataSourceRow, "AllowChargeBacks", SharedSettings.RegexAlfaNumeric, false));
