...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationMaintenance : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_configurationmaintenance"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxDate = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationMaintenance_Date"), entryDate);
                ...
                BOWidgetBox boxTime = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationMaintenance_Time"), entryTime);
                ...
                BOWidgetBox boxPasswordAccess = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationMaintenance_PasswordAccess"), entryPasswordAccess);
                ...
                BOWidgetBox boxRemarks = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationMaintenance_Remarks"), entryRemarks);
