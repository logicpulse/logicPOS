...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationWeighingMachine : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_configurationweighingmachine"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxPortName = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_hardware_com_portname"), entryPortName);
                ...
                BOWidgetBox boxBaudRate = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_hardware_com_baudrate"), entryBaudRate);
                ...
                BOWidgetBox boxParity = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_hardware_com_parity"), entryParity);
                ...
                BOWidgetBox boxStopBits = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_hardware_com_stopbits"), entryStopBits);
                ...
                BOWidgetBox boxDataBits = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_hardware_com_databits"), entryDataBits);
