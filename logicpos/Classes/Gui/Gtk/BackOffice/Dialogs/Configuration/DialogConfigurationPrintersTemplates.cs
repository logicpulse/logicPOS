    ...
    internal class DialogConfigurationPrintersTemplates : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxfileChooserFileTemplate = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_file"), fileChooserFileTemplate);
                ...
                //FinancialTemplate
                CheckButton checkButtonFinancialTemplate = new CheckButton(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_financialtemplate"));
