    ...
    internal class DialogConfigurationPrintersTemplates : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxfileChooserFileTemplate = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_file"), fileChooserFileTemplate);
                ...
                //FinancialTemplate
                CheckButton checkButtonFinancialTemplate = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_financialtemplate"));
