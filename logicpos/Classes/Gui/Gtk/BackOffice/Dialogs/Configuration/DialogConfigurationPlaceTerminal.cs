...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationPlaceTerminal : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_configurationplaceterminal"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxPlace = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_places"), xpoComboBoxPlace);
                ...
                BOWidgetBox boxHardwareId = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_hardware_id"), entryHardwareId);
                ...
                BOWidgetBox boxPrinter = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationPrinters"), xpoComboBoxPrinter);
                TreeIter iter;
                ...
                BOWidgetBox boxThermalPrinter = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_printer"), xpoComboBoxThermalPrinter);
                ...
                BOWidgetBox boxPoleDisplay = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationPoleDisplay"), xpoComboBoxPoleDisplay);
                ...
                BOWidgetBox boxWeighingMachine = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_ConfigurationWeighingMachine"), xpoComboBoxWeighingMachine);
                ...
                BOWidgetBox boxBarcodeReader = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_input_barcode_reader"), xpoComboBoxBarcodeReader);
                ...
                BOWidgetBox boxCardReader = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_input_reader_card_reader"), xpoComboBoxCardReader);
                ...
                BOWidgetBox boxInputReaderTimerInterval = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_input_reader_timer_interval"), entryInputReaderTimerInterval);
                ...
                _notebook.AppendPage(vboxTab2, new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_devices")));
