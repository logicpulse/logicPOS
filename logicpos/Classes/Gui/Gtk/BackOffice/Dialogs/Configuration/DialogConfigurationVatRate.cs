...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationVatRate : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_configurationvatrate"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxValue = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_vat_rate_value"), entryValue);
                ...
                BOWidgetBox boxTaxType = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_vat_rate_tax_type"), entryTaxType);
                ...
                BOWidgetBox boxTaxCode = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_vat_rate_tax_code"), entryTaxCode);
                ...
                BOWidgetBox boxTaxCountryRegion = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_vat_rate_tax_country_region"), entryTaxCountryRegion);
                ...
                BOWidgetBox boxTaxDescription = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_description"), entryTaxDescription);
