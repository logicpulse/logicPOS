...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    class DialogConfigurationVatRate : BOBaseDialog
    {
        ...
        {
            this.Title = Utils.GetWindowTitle(Resx.window_title_edit_configurationvatrate);
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxTaxType = new BOWidgetBox(Resx.global_vat_rate_tax_type, entryTaxType);
                ...
                BOWidgetBox boxTaxCode = new BOWidgetBox(Resx.global_vat_rate_tax_code, entryTaxCode);
                ...
                BOWidgetBox boxTaxCountryRegion = new BOWidgetBox(Resx.global_vat_rate_tax_country_region, entryTaxCountryRegion);
                ...
                BOWidgetBox boxTaxDescription = new BOWidgetBox(Resx.global_description, entryTaxDescription);
