    ...
    internal class DialogConfigurationVatRate : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxValue = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_vat_rate_value"), entryValue);
                ...
                BOWidgetBox boxTaxType = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_vat_rate_tax_type"), entryTaxType);
                ...
                BOWidgetBox boxTaxCode = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_vat_rate_tax_code"), entryTaxCode);
                ...
                BOWidgetBox boxTaxCountryRegion = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_vat_rate_tax_country_region"), entryTaxCountryRegion);
                ...
                BOWidgetBox boxTaxDescription = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.CultureSettings.CurrentCultureName, "global_description"), entryTaxDescription);
