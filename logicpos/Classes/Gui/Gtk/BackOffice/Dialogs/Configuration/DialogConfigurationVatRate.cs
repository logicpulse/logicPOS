...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationVatRate : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "window_title_edit_configurationvatrate"));

            if (logicpos.Utils.IsLinux) SetSizeRequest(500, 553);
            else
            {
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxValue = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_vat_rate_value"), entryValue);
                ...
                BOWidgetBox boxTaxType = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_vat_rate_tax_type"), entryTaxType);
                ...
                BOWidgetBox boxTaxCode = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_vat_rate_tax_code"), entryTaxCode);
                ...
                BOWidgetBox boxTaxCountryRegion = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_vat_rate_tax_country_region"), entryTaxCountryRegion);
                ...
                BOWidgetBox boxTaxDescription = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_description"), entryTaxDescription);
