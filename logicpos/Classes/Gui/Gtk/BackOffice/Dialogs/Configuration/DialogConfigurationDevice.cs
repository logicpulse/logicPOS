...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationDevice : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "window_title_edit_configurationdevice"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxPlaceTerminal = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_ConfigurationDevice_PlaceTerminal"), entryPlaceTerminal);
                vboxTab1.PackStart(boxPlaceTerminal, false, false, 0);
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(boxPlaceTerminal, _dataSourceRow, "PlaceTerminal", SharedSettings.RegexAlfaNumeric, false));
