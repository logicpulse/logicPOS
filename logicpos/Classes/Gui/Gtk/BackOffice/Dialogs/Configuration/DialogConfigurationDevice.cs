...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    class DialogConfigurationDevice : BOBaseDialog
    {
        ...
        {
            this.Title = Utils.GetWindowTitle(Resx.window_title_edit_configurationdevice);
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxPlaceTerminal = new BOWidgetBox(Resx.global_ConfigurationDevice_PlaceTerminal, entryPlaceTerminal);
