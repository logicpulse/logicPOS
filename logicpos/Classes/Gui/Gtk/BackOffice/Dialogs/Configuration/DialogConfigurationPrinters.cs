...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationPrinters : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_dialogconfigurationprinters"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxPrinterType = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_type"), _xpoComboBoxPrinterType);
               ...
               //Verifica tipo de impressora ativo na drop
                ...
                if (_printersOnSystem.Length != 0 /*&& getSelectedType != "-"*/)
                {
                    ...
                    _xpoComboBoxPrinterSelect = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_designation"), xpoComboBoxInputType);
                ...
                BOWidgetBox boxNetworkName = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_networkname"), entryNetworkName);
                ...
                BOWidgetBox boxThermalMaxCharsPerLineNormal = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_max_chars_per_line_normal"), _entryThermalMaxCharsPerLineNormal);
                ...
                BOWidgetBox boxThermalMaxCharsPerLineNormalBold = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_max_chars_per_line_normal_bold"), _entryThermalMaxCharsPerLineNormalBold);
                ...
                BOWidgetBox boxThermalMaxCharsPerLineSmall = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_max_chars_per_line_small"), _entryThermalMaxCharsPerLineSmall);
                ...
                BOWidgetBox boxThermalEncoding = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_encoding"), _entryThermalEncoding);
                ...
                BOWidgetBox boxThermalCutCommand = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_cut_command"), _entryThermalCutCommand);
                ...
                BOWidgetBox boxThermalOpenDrawerValueM = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_open_drawer_value_m"), _entryThermalOpenDrawerValueM);
                ...
                BOWidgetBox boxThermalOpenDrawerValueT1 = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_open_drawer_value_t1"), _entryThermalOpenDrawerValueT1);
                ...
                BOWidgetBox boxThermalOpenDrawerValueT2 = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_open_drawer_value_t2"), _entryThermalOpenDrawerValueT2);
                ...
                BOWidgetBox boxThermalImageCompanyLogo = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_image_company_loggero"), _entryThermalImageCompanyLogo);
                ...
                //ThermalPrintLogo
                CheckButton checkButtonThermalPrintLogo = new CheckButton(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_printer_thermal_print_loggero"));
                ...
                _notebook.AppendPage(_vboxTab2, new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_record_main_properties")));
            }
