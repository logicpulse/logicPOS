...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationCountry : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_dialog_configuration_country"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxCapital = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_country_capital"), entryCapital);
                ...
                BOWidgetBox boxCurrency = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_currency"), entryCurrency);
                ...
                BOWidgetBox boxCode2 = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_country_code2"), entryCode2);
                ...
                BOWidgetBox boxCode3 = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_country_code3"), entryCode3);
                ...
                BOWidgetBox boxCurrencyCode = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_currency_code"), entryCurrencyCode);
                ...
                BOWidgetBox boxRegExFiscalNumber = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_regex_fiscal_number"), entryRegExFiscalNumber);
                ...
                BOWidgetBox boxRegExZipCode = new BOWidgetBox(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_regex_postal_code"), entryRegExZipCode);
                ...
                //Append Tab
                _notebook.AppendPage(vboxTab2, new Label(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_others")));
            }
