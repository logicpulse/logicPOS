...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    class DialogConfigurationKeyboard : BOBaseDialog
    {
        ...
        {
            this.Title = Utils.GetWindowTitle(Resx.window_title_edit_configurationkeyboard);
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxLanguage = new BOWidgetBox(Resx.global_ConfigurationKeyboard_Language, entryLanguage);
                ...
                BOWidgetBox boxVirtualKeyboard = new BOWidgetBox(Resx.global_ConfigurationKeyboard_VirtualKeyboard, entryVirtualKeyboard);
