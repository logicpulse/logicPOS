...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationKeyboard : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_edit_configurationkeyboard"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxLanguage = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_ConfigurationKeyboard_Language"), entryLanguage);
                ...
                BOWidgetBox boxVirtualKeyboard = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_ConfigurationKeyboard_VirtualKeyboard"), entryVirtualKeyboard);
