...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationPlaceMovementType : BOBaseDialog
    {
            ...
            : base(pSourceWindow, pTreeView, pFlags, pDialogMode, pXPGuidObject)
        {
            ...
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_configurationplacemovementtype"), pDialogMode);
            InitUI();
            InitNotes();
            ShowAll();
        }
        ...
        private void InitUI()
        {
            try
            {
                ...
                {
                    CheckButton checkButtonVatDirectSelling = new CheckButton(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_vat_direct_selling"));
