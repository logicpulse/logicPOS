...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationUnitSize : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_configurationunitsize"));
