...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationUnitSize : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_edit_configurationunitsize"));
