...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    class DialogConfigurationPaymentCondition : BOBaseDialog
    {
        ...
        {
            this.Title = Utils.GetWindowTitle(Resx.window_title_edit_configurationpaymentcondition);
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxAcronym = new BOWidgetBox(Resx.global_ConfigurationPaymentCondition_Acronym, entryAcronym);
