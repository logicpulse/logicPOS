...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogConfigurationPaymentMethod : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_edit_configurationpaymentmethod"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxToken = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_ConfigurationPaymentMethod_Token"), entryToken);
                ...
                BOWidgetBox boxAcronym = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_ConfigurationPaymentMethod_Acronym"), entryAcronym);
                ...
                //BOWidgetBox boxSymbol = new BOWidgetBox(resources.CustomResources.GetCustomResources(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_ConfigurationPaymentMethod_Symbol, entrySymbol);
