...
{
    internal class DialogConfigurationPriceType : BOBaseDialog
    {
        ...
        {
            Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "window_title_edit_configurationpricetype"));

            if (logicpos.Utils.IsLinux) SetSizeRequest(500, 329);
            else SetSizeRequest(500, 309);
            InitUI();
            InitNotes();
            ShowAll();
        }
