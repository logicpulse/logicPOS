...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogUserProfile : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_user_profile"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                //AccessPassword
                CheckButton checkButtonAccessPassword = new CheckButton(CultureResources.GetLanguageResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_accesspassword"));
