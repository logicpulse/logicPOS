...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogUserDetail : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_user"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxName = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_name"), entryName);
                ...
                BOWidgetBox boxProfile = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_user_profiles"), xpoComboBoxProfile);
                ...
                BOWidgetBox boxCommissionGroup = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_commission_group"), xpoComboBoxCommissionGroup);
                ...
                BOWidgetBox boxDateOfContract = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_contract_date"), entryDateOfContract);
                ...
                _checkButtonPasswordReset = new CheckButton(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_reset_password"));
                ...
                BOWidgetBox boxResidence = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_address"), entryResidence);
                ...
                BOWidgetBox boxLocality = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_locality"), entryLocality);
                ...
                BOWidgetBox boxCity = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_city"), entryCity);
                ...
                BOWidgetBox boxZipCode = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_postal_code"), entryZipCode);
                ...
                BOWidgetBox boxFiscalNumber = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_fiscal_number"), entryFiscalNumber);
                ...
                BOWidgetBox boxLanguage = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_language"), entryLanguage);
                ...
                BOWidgetBox boxAssignedSeating = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_assigned_seating"), entryAssignedSeating);
                ...
                BOWidgetBox boxAccessCardNumber = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_access_card_number"), entryAccessCardNumber);
                ...
                BOWidgetBox boxBaseConsumption = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_base_consumption"), entryBaseConsumption);
                ...
                BOWidgetBox boxBaseOffers = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_base_offers"), entryBaseOffers);
                ...
                BOWidgetBox boxPVPOffers = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_price_offers"), entryPVPOffers);
        ...
        private void _crudWidgetList_AfterUpdate(object sender, EventArgs e)
        {
            ...
            if (_dialogMode == DialogMode.Update && _isLoggedUser && _currentUserPermissionProfileGuid != _userDetail.Profile.Oid)
            {
                ...
                logicpos.Utils.ShowMessageTouch(this, DialogFlags.Modal, MessageType.Info, ButtonsType.Ok, resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_information"), resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "dialog_message_user_profile_changed_request_loggeroff"));
            }
