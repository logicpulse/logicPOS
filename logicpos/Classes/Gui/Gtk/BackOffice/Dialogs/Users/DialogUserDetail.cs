    ...
    class DialogUserDetail : BOBaseDialog
    {
        ...
        private void InitUI()
        {
            try
            {
                ...
                //Profile
                XPOComboBox xpoComboBoxProfile = new XPOComboBox(DataSourceRow.Session, typeof(SYS_UserProfile), (DataSourceRow as SYS_UserDetail).Profile, "Designation");
                BOWidgetBox boxProfile = new BOWidgetBox(Resx.global_user_profiles, xpoComboBoxProfile);
                ...
                //CommissionGroup
                XPOComboBox xpoComboBoxCommissionGroup = new XPOComboBox(DataSourceRow.Session, typeof(POS_UserCommissionGroup), (DataSourceRow as SYS_UserDetail).CommissionGroup, "Designation");
                ...
                BOWidgetBox boxDateOfContract = new BOWidgetBox(Resx.global_contract_date, entryDateOfContract);
                ...
                _checkButtonPasswordReset = new CheckButton(Resx.global_reset_password);
                ...
                BOWidgetBox boxResidence = new BOWidgetBox(Resx.global_address, entryResidence);
                ...
                BOWidgetBox boxZipCode = new BOWidgetBox(Resx.global_postal_code, entryZipCode);
                ...
                BOWidgetBox boxFiscalNumber = new BOWidgetBox(Resx.global_fiscal_number, entryFiscalNumber);
                ...
                BOWidgetBox boxLanguage = new BOWidgetBox(Resx.global_language, entryLanguage);
                ...
                BOWidgetBox boxAssignedSeating = new BOWidgetBox(Resx.global_assigned_seating, entryAssignedSeating);
                ...
                BOWidgetBox boxAccessCardNumber = new BOWidgetBox(Resx.global_access_card_number, entryAccessCardNumber);
                ...
                BOWidgetBox boxBaseConsumption = new BOWidgetBox(Resx.global_base_consumption, entryBaseConsumption);
                ...
                BOWidgetBox boxBaseOffers = new BOWidgetBox(Resx.global_base_offers, entryBaseOffers);
                ...
                BOWidgetBox boxPVPOffers = new BOWidgetBox(Resx.global_price_offers, entryPVPOffers);
        ...
        private void _crudWidgetList_AfterUpdate(object sender, EventArgs e)
        {
            ...
            if (_dialogMode == DialogMode.Update && _isLoggedUser && _currentUserPermissionProfileGuid != _userDetail.Profile.Oid)
            {
                ...
                Utils.ShowMessageTouch(this, DialogFlags.Modal, MessageType.Info, ButtonsType.Ok, Resx.global_information, Resx.dialog_message_user_profile_changed_request_logoff);
            }
