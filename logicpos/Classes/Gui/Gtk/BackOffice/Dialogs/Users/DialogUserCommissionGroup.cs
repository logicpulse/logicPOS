...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogUserCommissionGroup : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "window_title_edit_user_commission_group"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxCommission = new BOWidgetBox(resources.CustomResources.GetCustomResources(DataLayerFramework.Settings["customCultureResourceDefinition"], "global_commission"), entryCommission);
                vboxTab1.PackStart(boxCommission, false, false, 0);
                _crudWidgetList.Add(new GenericCRUDWidgetXPO(boxCommission, _dataSourceRow, "Commission", SharedSettings.RegexPercentage, true));
