...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogUserCommissionGroup : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "window_title_edit_user_commission_group"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxCommission = new BOWidgetBox(CultureResources.GetResourceByLanguage(LogicPOS.Settings.GeneralSettings.Settings.GetCultureName(), "global_commission"), entryCommission);
