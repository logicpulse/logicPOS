...
namespace logicpos.Classes.Gui.Gtk.BackOffice
{
    internal class DialogUserCommissionGroup : BOBaseDialog
    {
        ...
        {
            this.Title = logicpos.Utils.GetWindowTitle(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "window_title_edit_user_commission_group"));
        ...
        private void InitUI()
        {
            try
            {
                ...
                BOWidgetBox boxCommission = new BOWidgetBox(resources.CustomResources.GetCustomResource(LogicPOS.Settings.GeneralSettings.Settings["customCultureResourceDefinition"], "global_commission"), entryCommission);
