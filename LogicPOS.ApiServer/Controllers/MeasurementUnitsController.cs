...
[AllowAnonymous]
[Route("articles/measurementunits")]
[Route("api/articles/measurementunits")]
public sealed class MeasurementUnitsController : ApiControllerBase
{
    private readonly MeasurementUnitService _service;

    public MeasurementUnitsController(MeasurementUnitService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] AddMeasurementUnitRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateMeasurementUnitRequest request, CancellationToken cancellationToken)
    {
